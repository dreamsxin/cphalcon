...
PHP_METHOD(Phalcon_Assets_Collection, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 138, asset);
...
PHP_METHOD(Phalcon_Assets_Collection, addCss) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 139, &path, &collectionLocal, &_1, &collectionAttributes, &version, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Assets_Collection, addInline) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "addasset", NULL, 138, code);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Assets_Collection, addInlineCss) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 140, &content, &_1, &collectionAttributes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Assets_Collection, addInlineJs) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 141, &content, &_1, &collectionAttributes);
	zephir_check_call_status();
	zephir_update_property_array_append(this_ptr, SL("codes"), &_0);
	ZEPHIR_INIT_NVAR(&_0);
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Assets_Collection, addJs) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 142, &path, &collectionLocal, &_1, &collectionAttributes, &version, &_2);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "add", NULL, 0, &_0);
	zephir_check_call_status();
	RETURN_THIS();
