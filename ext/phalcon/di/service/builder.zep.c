...
PHP_METHOD(Phalcon_Di_Service_Builder, build) {
	...
	if (Z_TYPE_P(parameters) == IS_ARRAY) {
		...
		if (zephir_array_isset_string_fetch(&arguments, &definition, SL("arguments"), 0)) {
			ZEPHIR_CALL_METHOD(&_0$$8, this_ptr, "buildparameters", NULL, 206, container, &arguments);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&instance);
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _3$$10, _4$$10, _1$$10)
			{
				...
				if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
					...
					if (zephir_fast_count_int(&arguments TSRMLS_CC)) {
						...
						ZEPHIR_CALL_METHOD(&_13$$18, this_ptr, "buildparameters", NULL, 206, container, &arguments);
						zephir_check_call_status();
				...
				zephir_check_call_status();
					...
					if (zephir_array_isset_string_fetch(&arguments, &method, SL("arguments"), 0)) {
						...
						if (zephir_fast_count_int(&arguments TSRMLS_CC)) {
							...
							ZEPHIR_CALL_METHOD(&_23$$24, this_ptr, "buildparameters", NULL, 206, container, &arguments);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&paramCalls, &definition, SL("properties"), 0)) {
		...
		if (Z_TYPE_P(&paramCalls) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&paramCalls), _27$$25, _28$$25, _25$$25)
			{
				...
				ZEPHIR_CALL_METHOD(&_35$$28, this_ptr, "buildparameter", &_36, 207, container, &propertyPosition, &propertyValue);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_43$$32, this_ptr, "buildparameter", &_36, 207, container, &propertyPosition, &propertyValue);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di_Service_Builder, buildParameters) {
	...
	if (Z_TYPE_P(&arguments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&arguments), _2, _3, _0)
		{
			...
			ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "buildparameter", &_5, 207, container, &position, &argument);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "buildparameter", &_5, 207, container, &position, &argument);
				zephir_check_call_status();
