...
PHP_METHOD(Phalcon_Session_Manager, destroy) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		ZEPHIR_CALL_FUNCTION(NULL, "session_destroy", NULL, 483);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Manager, exists) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "session_status", NULL, 484);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Manager, get) {
	...
	ZEPHIR_CALL_METHOD(&uniqueKey, this_ptr, "getuniquekey", NULL, 485, &key);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Manager, getId) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_id", NULL, 486);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Manager, getName) {
	...
	if (!ZEPHIR_IS_IDENTICAL(&_1, &_0)) {
		ZEPHIR_CALL_FUNCTION(&_2$$3, "session_name", NULL, 487);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Session_Manager, regenerateId) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "session_regenerate_id", NULL, 488, &_1$$3);
		zephir_check_call_status();
	}
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Session_Manager, registerHandler) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("session_set_save_handler", NULL, 489, handler);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Session_Manager, setId) {
	...
	if (UNEXPECTED(ZEPHIR_IS_TRUE_IDENTICAL(&_0))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 252, &_2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_1$$3, "phalcon/Session/Manager.zep", 280 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_FUNCTION(NULL, "session_id", NULL, 486, &id);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Session_Manager, setName) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "session_name", NULL, 487, &name);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Session_Manager, start) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "headers_sent", NULL, 348);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "session_start", NULL, 490);
	zephir_check_call_status();
	RETURN_MM_BOOL(1);
...
PHP_METHOD(Phalcon_Session_Manager, status) {
	...
	ZEPHIR_CALL_FUNCTION(&status, "session_status", NULL, 484);
	zephir_check_call_status();
	do {
