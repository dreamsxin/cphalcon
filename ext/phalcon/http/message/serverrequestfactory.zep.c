...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, load) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checknullarray", NULL, 288, &server, &_SERVER);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&server, &_0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "checknullarray", NULL, 288, &files, &_FILES);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&files, &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checknullarray", NULL, 288, &cookies, &_COOKIE);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&cookies, &_2);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checknullarray", NULL, 288, &get, &_GET);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&get, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "checknullarray", NULL, 288, &post, &_POST);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&headers, this_ptr, "parseheaders", NULL, 290, &serverCollection);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&filesCollection, this_ptr, "parseuploadedfiles", NULL, 291, &files);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_6)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&cookies, this_ptr, "parsecookieheader", NULL, 292, &_8$$3);
		zephir_check_call_status();
	}
	object_init_ex(return_value, phalcon_http_message_serverrequest_ce);
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "parseuri", NULL, 293, &serverCollection, &headers);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 287, &method, &_10, &_11, &_4, &_12, &cookies, &get, &_13, &post, &protocol);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriHost) {
	...
	ZVAL_STRING(&_0, "host");
	ZVAL_BOOL(&_2, 0);
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getheader", NULL, 294, headers, &_0, &_2);
	zephir_check_call_status();
	if (UNEXPECTED(zephir_is_true(&_1))) {
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "host");
		ZEPHIR_CALL_METHOD(&host, this_ptr, "getheader", NULL, 294, headers, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "calculateurihostfromheader", NULL, 295, &host);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriPath) {
	...
	if (UNEXPECTED(Z_TYPE_P(&requestUri) != IS_NULL)) {
		...
		ZVAL_STRING(&_6$$4, "");
		ZEPHIR_RETURN_CALL_FUNCTION("preg_replace", NULL, 40, &_5$$4, &_6$$4, &requestUri);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_INIT_NVAR(&_0);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, calculateUriScheme) {
	...
	ZEPHIR_CALL_METHOD(&header, this_ptr, "getheader", NULL, 294, headers, &_1, &_8);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, createUploadedFile) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 296, &_4, &_5, &_6, &name, &type);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseCookieHeader) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "strtr", NULL, 82, &cookieHeader, &_0);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&cookies);
	ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 297, &_1, &cookies);
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseHeaders) {
	...
	ZEPHIR_CALL_METHOD(NULL, &headers, "__construct", NULL, 32);
	zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&serverArray), _2, _3, _0)
		{
			...
			if (EXPECTED(!ZEPHIR_IS_IDENTICAL(&_4$$3, &value))) {
				...
				if (EXPECTED(ZEPHIR_IS_LONG_IDENTICAL(&_12$$4, 0))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &headers, "set", &_18, 33, &name, &value);
					zephir_check_call_status();
					continue;
				}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseServer) {
	...
	ZEPHIR_CALL_METHOD(NULL, &collection, "__construct", NULL, 32, &server);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&headers, this_ptr, "getheaders", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "HTTP_AUTHORIZATION");
	ZEPHIR_CALL_METHOD(&_0, &collection, "has", NULL, 298, &_1);
	zephir_check_call_status();
	...
	if (UNEXPECTED(_2)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &headersCollection, "__construct", NULL, 32, &headers);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "Authorization");
		ZEPHIR_CALL_METHOD(&_3$$3, &headersCollection, "has", NULL, 298, &_4$$3);
		zephir_check_call_status();
		if (UNEXPECTED(zephir_is_true(&_3$$3))) {
			ZEPHIR_INIT_VAR(&_6$$4);
			ZVAL_STRING(&_6$$4, "Authorization");
			ZEPHIR_CALL_METHOD(&_5$$4, &headersCollection, "get", NULL, 299, &_6$$4);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_6$$4);
			ZVAL_STRING(&_6$$4, "HTTP_AUTHORIZATION");
			ZEPHIR_CALL_METHOD(NULL, &collection, "set", NULL, 33, &_6$$4, &_5$$4);
			zephir_check_call_status();
		}
	}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseUploadedFiles) {
	...
	ZEPHIR_INIT_VAR(&collection);
	object_init_ex(&collection, phalcon_collection_collection_ce);
	ZEPHIR_CALL_METHOD(NULL, &collection, "__construct", NULL, 32);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&files) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&files), _2, _3, _0)
		{
			...
			if (UNEXPECTED(_5$$3)) {
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 33, &key, &file);
				zephir_check_call_status();
				continue;
			}
			...
			if (EXPECTED(_7$$3)) {
				ZEPHIR_CALL_METHOD(&_8$$5, this_ptr, "createuploadedfile", &_9, 300, &file);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 33, &key, &_8$$5);
				zephir_check_call_status();
				continue;
			}
			if (UNEXPECTED(Z_TYPE_P(&file) == IS_ARRAY)) {
				ZEPHIR_CALL_METHOD(&data, this_ptr, "parseuploadedfiles", &_10, 291, &file);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_11$$6, &data, "toarray", &_12, 0);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 33, &key, &_11$$6);
				zephir_check_call_status();
				continue;
			}
		} ZEND_HASH_FOREACH_END();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (EXPECTED(_15$$7)) {
					ZEPHIR_CALL_METHOD(&_16$$9, this_ptr, "createuploadedfile", &_9, 300, &file);
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 33, &key, &_16$$9);
					zephir_check_call_status();
					continue;
				}
				if (UNEXPECTED(Z_TYPE_P(&file) == IS_ARRAY)) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &collection, "set", &_6, 33, &key, &_17$$10);
					zephir_check_call_status();
					continue;
				}
...
PHP_METHOD(Phalcon_Http_Message_ServerRequestFactory, parseUri) {
	...
	ZEPHIR_CALL_METHOD(NULL, &uri, "__construct", NULL, 95);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&scheme, this_ptr, "calculateurischeme", NULL, 301, server, headers);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &uri, "withscheme", NULL, 302, &scheme);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&uri, &_0);
	ZEPHIR_CALL_METHOD(&split, this_ptr, "calculateurihost", NULL, 303, server, headers);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&_1);
	...
	if (EXPECTED(!(ZEPHIR_IS_EMPTY(&_1)))) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, &uri, "withhost", NULL, 304, &_3$$3);
		zephir_check_call_status();
		...
		if (UNEXPECTED(!(ZEPHIR_IS_EMPTY(&_4$$3)))) {
			...
			ZEPHIR_CALL_METHOD(&_5$$4, &uri, "withport", NULL, 305, &_6$$4);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&uri, &_5$$4);
		}
	}
	ZEPHIR_CALL_METHOD(&path, this_ptr, "calculateuripath", NULL, 306, server);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_0, &uri, "withpath", NULL, 307, &_8);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&uri, &_0);
	if (UNEXPECTED(zephir_fast_count_int(&split TSRMLS_CC) > 1)) {
		...
		ZEPHIR_CALL_METHOD(&_9$$5, &uri, "withfragment", NULL, 308, &_10$$5);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(&uri, &_9$$5);
	}
	ZEPHIR_CALL_METHOD(&query, this_ptr, "calculateuriquery", NULL, 309, server);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, &uri, "withquery", NULL, 310, &query);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&uri, &_0);
	RETURN_CCTOR(&uri);
