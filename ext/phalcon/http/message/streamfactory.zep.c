...
PHP_METHOD(Phalcon_Http_Message_StreamFactory, createStream) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "r+b");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 77, &_0, &_1);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "rewind", NULL, 311, &handle);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "createstreamfromresource", NULL, 312, &handle);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_StreamFactory, createStreamFromFile) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 34, &filename, &mode);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_StreamFactory, createStreamFromResource) {
	...
	object_init_ex(return_value, phalcon_http_message_stream_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 34, phpResource);
	zephir_check_call_status();
	RETURN_MM();
