...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, __construct) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "processprotocol", NULL, 28, &protocol);
	zephir_check_call_status();
	zephir_update_property_zval(this_ptr, SL("protocolVersion"), &_1);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "processmethod", NULL, 94, &method);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "w+b");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "processbody", NULL, 27, body, &_6);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_6, "__construct", NULL, 32);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withAttribute) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, &attributes, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withCookieParams) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, &cookies, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withParsedBody) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, data, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withQueryParams) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, &query, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_ServerRequest, withUploadedFiles) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, &uploadedFiles, &_0);
	zephir_check_call_status();
	RETURN_MM();
