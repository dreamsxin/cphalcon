...
PHP_METHOD(Phalcon_Http_Message_AbstractRequest, withMethod) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "processmethod", NULL, 94, method);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "method");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, method, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractRequest, withRequestTarget) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, requestTarget, &_4);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_AbstractRequest, withUri) {
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "uri");
	ZEPHIR_CALL_METHOD(&newInstance, this_ptr, "cloneinstance", NULL, 7, uri, &_3);
	zephir_check_call_status();
	if (UNEXPECTED(!zephir_is_true(preserveHost))) {
		ZEPHIR_CALL_METHOD(&_4$$3, this_ptr, "checkheaderhost", NULL, 36, &headers);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_AbstractRequest, processUri) {
	...
	if (EXPECTED(Z_TYPE_P(uri) == IS_STRING)) {
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 95, uri);
		zephir_check_call_status();
		RETURN_MM();
	}
