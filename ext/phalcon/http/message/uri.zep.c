...
PHP_METHOD(Phalcon_Http_Message_Uri, __construct) {
	...
	if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_0, &uri))) {
		ZEPHIR_CALL_FUNCTION(&urlParts, "parse_url", NULL, 103, &uri);
		...
		ZVAL_STRING(&_5$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_2$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_4$$3, &_5$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "filterfragment", NULL, 320, &_2$$3);
		zephir_check_call_status();
		...
		ZVAL_STRING(&_7$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_6$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_7$$3);
		zephir_check_call_status();
		...
		ZVAL_STRING(&_7$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_8$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_7$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_9$$3, "rawurlencode", NULL, 211, &_8$$3);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(&_7$$3);
		ZVAL_STRING(&_7$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_11$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_7$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_10$$3, this_ptr, "filterpath", NULL, 321, &_11$$3);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("path"), &_10$$3);
		ZEPHIR_INIT_NVAR(&_5$$3);
		ZVAL_STRING(&_5$$3, "port");
		ZVAL_NULL(&_14$$3);
		ZEPHIR_CALL_CE_STATIC(&_13$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_14$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_12$$3, this_ptr, "filterport", NULL, 322, &_13$$3);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(&_7$$3);
		ZVAL_STRING(&_7$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_16$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_7$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_15$$3, this_ptr, "filterquery", NULL, 323, &_16$$3);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(&_7$$3);
		ZVAL_STRING(&_7$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_18$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_7$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_17$$3, this_ptr, "filterscheme", NULL, 324, &_18$$3);
		zephir_check_call_status();
		...
		ZEPHIR_INIT_NVAR(&_7$$3);
		ZVAL_STRING(&_7$$3, "");
		ZEPHIR_CALL_CE_STATIC(&_19$$3, phalcon_helper_arr_ce, "get", &_3, 5, &urlParts, &_5$$3, &_7$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_20$$3, "rawurlencode", NULL, 211, &_19$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, __toString) {
	...
	ZEPHIR_CALL_METHOD(&authority, this_ptr, "getauthority", NULL, 325);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_8);
	ZVAL_STRING(&_8, ":");
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "checkvalue", NULL, 326, &_0, &_7, &_8);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "//");
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "checkvalue", NULL, 326, &authority, &_7);
	zephir_check_call_status();
	zephir_read_property(&_11, this_ptr, SL("query"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "?");
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "checkvalue", NULL, 326, &_11, &_7);
	zephir_check_call_status();
	zephir_read_property(&_13, this_ptr, SL("fragment"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_INIT_NVAR(&_7);
	ZVAL_STRING(&_7, "#");
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "checkvalue", NULL, 326, &_13, &_7);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&uri);
...
PHP_METHOD(Phalcon_Http_Message_Uri, getAuthority) {
	...
	ZEPHIR_CALL_METHOD(&userInfo, this_ptr, "getuserinfo", NULL, 327);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_STRING(&_2, "");
...
PHP_METHOD(Phalcon_Http_Message_Uri, withFragment) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 6, fragment);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "filterfragment", NULL, 320, fragment);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(fragment, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "fragment");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, fragment, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPath) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 6, path);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "?");
	ZEPHIR_INIT_VAR(&_1);
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "filterpath", NULL, 321, path);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(path, &_5);
	ZEPHIR_INIT_VAR(&_6);
	ZVAL_STRING(&_6, "path");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, path, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withPort) {
	...
	if (UNEXPECTED(Z_TYPE_P(port) != IS_NULL)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "filterport", NULL, 322, port);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "port");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, port, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withQuery) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 6, query);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "#");
	ZEPHIR_INIT_VAR(&_1);
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "filterquery", NULL, 323, query);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(query, &_2);
	ZEPHIR_INIT_VAR(&_3);
	ZVAL_STRING(&_3, "query");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "cloneinstance", NULL, 7, query, &_3);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withScheme) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 6, scheme);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "filterscheme", NULL, 324, scheme);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(scheme, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "scheme");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 328, scheme, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withUserInfo) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 6, user);
	zephir_check_call_status();
	if (UNEXPECTED(Z_TYPE_P(password) != IS_NULL)) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkstringparameter", NULL, 6, user);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_FUNCTION(&_0, "rawurlencode", NULL, 211, user);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(user, &_0);
	if (UNEXPECTED(Z_TYPE_P(password) != IS_NULL)) {
		ZEPHIR_CALL_FUNCTION(&_1$$4, "rawurlencode", NULL, 211, password);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(password, &_1$$4);
	}
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "user");
	ZEPHIR_CALL_METHOD(&newInstance, this_ptr, "cloneinstance", NULL, 7, user, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, withHost) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "host");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "processwith", NULL, 328, host, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterFragment) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 211, &fragment);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterPath) {
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _4, _5, _2)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_6$$4, "rawurlencode", &_7, 211, &element);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_FUNCTION(&_8$$5, "rawurlencode", &_7, 211, &element);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterQuery) {
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parts), _5, _6, _3)
		{
			...
			ZVAL_COPY(&part, _3);
			ZEPHIR_CALL_METHOD(&split, this_ptr, "splitqueryvalue", &_7, 329, &part);
			zephir_check_call_status();
			...
			if (UNEXPECTED(Z_TYPE_P(&_8$$4) == IS_NULL)) {
				...
				ZEPHIR_CALL_FUNCTION(&_10$$5, "rawurlencode", &_11, 211, &_9$$5);
				zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_13$$4, "rawurlencode", &_11, 211, &_12$$4);
			zephir_check_call_status();
			zephir_array_fetch_long(&_14$$4, &split, 1, PH_NOISY | PH_READONLY, "phalcon/Http/Message/Uri.zep", 595 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_15$$4, "rawurlencode", &_11, 211, &_14$$4);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(Z_TYPE_P(&_17$$6) == IS_NULL)) {
					...
					ZEPHIR_CALL_FUNCTION(&_19$$7, "rawurlencode", &_11, 211, &_18$$7);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_21$$6, "rawurlencode", &_11, 211, &_20$$6);
				zephir_check_call_status();
				zephir_array_fetch_long(&_22$$6, &split, 1, PH_NOISY | PH_READONLY, "phalcon/Http/Message/Uri.zep", 595 TSRMLS_CC);
				ZEPHIR_CALL_FUNCTION(&_23$$6, "rawurlencode", &_11, 211, &_22$$6);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Uri, filterScheme) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mb_strtolower", NULL, 250, &scheme);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "#:(//)?$#");
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "");
	ZEPHIR_CALL_FUNCTION(&filtered, "preg_replace", NULL, 40, &_1, &_2, &_0);
	zephir_check_call_status();
	...
	if (UNEXPECTED(!(zephir_array_isset(&schemes, &filtered)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 30, &_7$$4);
		zephir_check_call_status();
