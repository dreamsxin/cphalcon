...
PHP_METHOD(Phalcon_Http_Message_Stream, getContents) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 67);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkreadable", NULL, 68);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&data, "stream_get_contents", NULL, 69, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, getMetadata) {
	...
	ZEPHIR_CALL_FUNCTION(&metadata, "stream_get_meta_data", NULL, 70, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, getSize) {
	...
	if (EXPECTED(Z_TYPE_P(&_0) != IS_NULL)) {
		zephir_read_property(&_1$$3, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&stats, "fstat", NULL, 71, &_1$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, isReadable) {
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "r+");
	ZEPHIR_CALL_FUNCTION(&_3, "strpbrk", NULL, 72, &mode, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, read) {
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&data, "fread", NULL, 73, &_0, length);
	zephir_check_call_status();
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&data))) {
...
PHP_METHOD(Phalcon_Http_Message_Stream, seek) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 67);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkseekable", NULL, 74);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&seeker, "fseek", NULL, 75, &_0, offset, whence);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, setStream) {
	...
	if (EXPECTED(Z_TYPE_P(stream) == IS_STRING)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 76, &_0$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&handle, "fopen", NULL, 77, stream, &mode);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "restore_error_handler", NULL, 78);
		zephir_check_call_status();
	}
	ZEPHIR_OBS_VAR(&_1);
	...
	_3 = _2;
	if (!(_3)) {
		ZEPHIR_CALL_FUNCTION(&_4, "get_resource_type", NULL, 79, &handle);
		zephir_check_call_status();
		ZEPHIR_SINIT_VAR(_5);
...
PHP_METHOD(Phalcon_Http_Message_Stream, tell) {
	...
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(&position, "ftell", NULL, 80, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Message_Stream, write) {
	...
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkhandle", NULL, 67);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "checkwritable", NULL, 81);
	zephir_check_call_status();
	zephir_read_property(&_0, this_ptr, SL("handle"), PH_NOISY_CC | PH_READONLY);
