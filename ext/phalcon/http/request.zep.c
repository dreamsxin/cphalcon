...
PHP_METHOD(Phalcon_Http_Request, get) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 330, &_REQUEST, &name, filters, defaultValue, &_0, &_1);
...
PHP_METHOD(Phalcon_Http_Request, getAcceptableContent) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getqualityheader", NULL, 331, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getBestAccept) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "accept");
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "getbestquality", NULL, 332, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getHeader) {
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "_");
	ZEPHIR_CALL_FUNCTION(&_2, "strtr", NULL, 82, &header, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&name);
	...
	if (Z_TYPE_P(&_SERVER) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_SERVER), _2, _3, _0)
		{
			...
			if (zephir_start_with_str(&name, SL("HTTP_"))) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 226, &_4$$4);
				zephir_check_call_status();
			...
			if (zephir_array_isset(&contentHeaders, &name)) {
				...
				ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 226, &_15$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_start_with_str(&name, SL("HTTP_"))) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 226, &_22$$7);
					zephir_check_call_status();
				...
				if (zephir_array_isset(&contentHeaders, &name)) {
					...
					ZEPHIR_CALL_FUNCTION(&name, "ucwords", &_10, 226, &_32$$8);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getHttpHost) {
	...
	if (_3) {
		...
		if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 467)) {
			...
			ZVAL_STRING(&_6$$6, "");
			ZEPHIR_CALL_FUNCTION(&_7$$6, "preg_replace", NULL, 40, &_5$$6, &_6$$6, &host);
			zephir_check_call_status();
		...
		ZVAL_STRING(&_9$$5, "");
		ZEPHIR_CALL_FUNCTION(&_10$$5, "preg_replace", NULL, 40, &_8$$5, &_9$$5, &host);
		zephir_check_call_status();
		...
		if (UNEXPECTED(!ZEPHIR_IS_IDENTICAL(&_11$$5, &_10$$5))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$7, "__construct", NULL, 333, &_13$$7);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getMethod) {
	...
	if (ZEPHIR_IS_IDENTICAL(&_0, &returnMethod)) {
		...
		ZEPHIR_CALL_METHOD(&overridedMethod, this_ptr, "getheader", NULL, 334, &_1$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPort) {
	...
	if (zephir_memnstr_str(&host, SL(":"), "phalcon/Http/Request.zep", 580)) {
		...
		ZVAL_STRING(&_3$$4, ":");
		ZEPHIR_CALL_FUNCTION(&pos, "strrpos", NULL, 159, &host, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getPost) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 330, &_POST, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getPut) {
	...
	if (Z_TYPE_P(&put) != IS_ARRAY) {
		...
		if (_0$$3) {
			...
			ZEPHIR_CALL_FUNCTION(&_2$$3, "stripos", NULL, 335, &contentType, &_1$$3);
			zephir_check_call_status();
		...
		if (_0$$3) {
			...
			zephir_check_call_status();
			ZEPHIR_MAKE_REF(&put);
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 297, &_4$$6, &put);
			ZEPHIR_UNREF(&put);
			zephir_check_call_status();
		}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 330, &put, &name, filters, defaultValue, &_5, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getQuery) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "gethelper", NULL, 330, &_GET, &name, filters, defaultValue, &_0, &_1);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Http_Request, getServerAddress) {
	...
	if (!(zephir_array_isset_string_fetch(&serverAddr, &_SERVER, SL("SERVER_ADDR"), 0))) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("gethostbyname", NULL, 336, &_0$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
		...
		if (Z_TYPE_P(&superFiles) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&superFiles), _2$$3, _3$$3, _0$$3)
			{
				...
				if (Z_TYPE_P(&_4$$4) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 337, &_5$$5, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &prefix);
					zephir_check_call_status();
						...
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _11$$5)
						{
							...
							if (_13$$6) {
								...
								if (namedKeys == 1) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_16$$8, "__construct", &_18, 338, &dataFile, &_17$$8);
									zephir_check_call_status();
									...
									ZEPHIR_CALL_METHOD(NULL, &_20$$9, "__construct", &_18, 338, &dataFile, &_21$$9);
									zephir_check_call_status();
							...
							zephir_check_call_status();
								...
								if (_22$$10) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_26$$12, "__construct", &_18, 338, &dataFile, &_27$$12);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_29$$13, "__construct", &_18, 338, &dataFile, &_30$$13);
										zephir_check_call_status();
					...
					if (_31$$14) {
						if (namedKeys == 1) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_33$$16, "__construct", &_18, 338, &input, &prefix);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_METHOD(NULL, &_34$$17, "__construct", &_18, 338, &input, &prefix);
							zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (Z_TYPE_P(&_35$$18) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&smoothInput, this_ptr, "smoothfiles", &_10, 337, &_36$$19, &_37$$19, &_38$$19, &_39$$19, &_40$$19, &prefix);
						zephir_check_call_status();
						zephir_is_iterable(&smoothInput, 0, "phalcon/Http/Request.zep", 813);
						if (Z_TYPE_P(&smoothInput) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&smoothInput), _41$$19)
							{
								...
								if (_43$$20) {
									...
									if (namedKeys == 1) {
										...
										ZEPHIR_CALL_METHOD(NULL, &_47$$22, "__construct", &_18, 338, &dataFile, &_48$$22);
										zephir_check_call_status();
										...
										ZEPHIR_CALL_METHOD(NULL, &_50$$23, "__construct", &_18, 338, &dataFile, &_51$$23);
										zephir_check_call_status();
								...
								zephir_check_call_status();
									...
									if (_52$$24) {
										...
										if (namedKeys == 1) {
											...
											ZEPHIR_CALL_METHOD(NULL, &_56$$26, "__construct", &_18, 338, &dataFile, &_57$$26);
											zephir_check_call_status();
											...
											ZEPHIR_CALL_METHOD(NULL, &_59$$27, "__construct", &_18, 338, &dataFile, &_60$$27);
											zephir_check_call_status();
						...
						if (_61$$28) {
							if (namedKeys == 1) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_63$$30, "__construct", &_18, 338, &input, &prefix);
								zephir_check_call_status();
								...
								ZEPHIR_CALL_METHOD(NULL, &_64$$31, "__construct", &_18, 338, &input, &prefix);
								zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&files), _0)
		{
			...
			if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
				...
				if (Z_TYPE_P(&error) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_3$$8, this_ptr, "hasfilehelper", &_5, 339, &error, &_4$$8);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_array_isset_string_fetch(&error, &file, SL("error"), 0)) {
					...
					if (Z_TYPE_P(&error) == IS_ARRAY) {
						...
						ZEPHIR_CALL_METHOD(&_7$$13, this_ptr, "hasfilehelper", &_5, 339, &error, &_8$$13);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isConnect) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getmethod", NULL, 340);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, isMethod) {
	...
	ZEPHIR_CALL_METHOD(&httpMethod, this_ptr, "getmethod", NULL, 340);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(methods) == IS_ARRAY) {
		...
		if (Z_TYPE_P(methods) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(methods), _4$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "ismethod", &_8, 341, &method, &_7$$6);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_9$$8, this_ptr, "ismethod", &_8, 341, &method, &_10$$8);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(data), _0)
		{
			...
			if (Z_TYPE_P(&value) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&_3$$7, this_ptr, "hasfilehelper", &_5, 339, &value, &_4$$7);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&value) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_7$$11, this_ptr, "hasfilehelper", &_5, 339, &value, &_8$$11);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, getQualityHeader) {
	...
	ZVAL_LONG(&_2, -1);
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_FUNCTION(&parts, "preg_split", NULL, 89, &_1, &_0, &_2, &_3);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&parts) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&parts), _4)
		{
			...
			ZVAL_LONG(&_8$$3, -1);
			ZVAL_LONG(&_9$$3, 1);
			ZEPHIR_CALL_FUNCTION(&_10$$3, "preg_split", NULL, 89, &_7$$3, &_6$$3, &_8$$3, &_9$$3);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZVAL_LONG(&_31$$14, -1);
				ZVAL_LONG(&_32$$14, 1);
				ZEPHIR_CALL_FUNCTION(&_33$$14, "preg_split", NULL, 89, &_30$$14, &_29$$14, &_31$$14, &_32$$14);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Http_Request, resolveAuthorizationHeaders) {
	...
	if (_9) {
		...
		if (zephir_is_true(&authHeader)) {
			...
			ZEPHIR_CALL_FUNCTION(&_13$$11, "stripos", NULL, 335, &authHeader, &_12$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_12$$11);
			ZVAL_STRING(&_12$$11, "digest ");
			ZEPHIR_CALL_FUNCTION(&_14$$11, "stripos", NULL, 335, &authHeader, &_12$$11);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_16$$11, "stripos", NULL, 335, &authHeader, &_12$$11);
			zephir_check_call_status();
			if (ZEPHIR_IS_LONG_IDENTICAL(&_13$$11, 0)) {
				ZVAL_LONG(&_17$$12, 6);
				ZEPHIR_INIT_VAR(&_18$$12);
				zephir_substr(&_18$$12, &authHeader, 6 , 0, ZEPHIR_SUBSTR_NO_LENGTH);
				ZEPHIR_CALL_FUNCTION(&_19$$12, "base64_decode", NULL, 165, &_18$$12);
				zephir_check_call_status();
	...
	if (!(zephir_array_isset_string(&headers, SL("Authorization")))) {
		...
		if (zephir_array_isset_string(&headers, SL("Php-Auth-User"))) {
			...
			ZEPHIR_CALL_FUNCTION(&_25$$17, "base64_encode", NULL, 168, &_24$$17);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&names) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&names), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(&name) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 337, &_6$$5, &_7$$5, &_8$$5, &_9$$5, &_10$$5, &p);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&name) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&parentFiles, this_ptr, "smoothfiles", &_11, 337, &_16$$10, &_17$$10, &_18$$10, &_19$$10, &_20$$10, &p);
					zephir_check_call_status();
					zephir_is_iterable(&parentFiles, 0, "phalcon/Http/Request.zep", 1452);
					if (Z_TYPE_P(&parentFiles) == IS_ARRAY) {
