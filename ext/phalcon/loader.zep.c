				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _10$$6)
				{
					...
					if (Z_TYPE_P(&extensions) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _13$$9)
						{
							...
							ZEPHIR_CALL_FUNCTION(&_17$$10, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								ZEPHIR_CALL_FUNCTION(&_23$$14, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _27$$18)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_31$$19, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_36$$23, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
					...
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _42$$27)
					{
						...
						if (Z_TYPE_P(&extensions) == IS_ARRAY) {
							ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _45$$30)
							{
								...
								ZEPHIR_CALL_FUNCTION(&_49$$31, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
								zephir_check_call_status();
							...
							while (1) {
								...
								zephir_check_call_status();
									...
									ZEPHIR_CALL_FUNCTION(&_54$$35, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
						...
						zephir_check_call_status();
							...
							if (Z_TYPE_P(&extensions) == IS_ARRAY) {
								ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _58$$39)
								{
									...
									ZEPHIR_CALL_FUNCTION(&_62$$40, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
									zephir_check_call_status();
								...
								while (1) {
									...
									zephir_check_call_status();
										...
										ZEPHIR_CALL_FUNCTION(&_67$$44, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
										zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&directories), _70)
		{
			...
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _73$$48)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_77$$49, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_82$$53, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&extensions), _86$$57)
					{
						...
						ZEPHIR_CALL_FUNCTION(&_90$$58, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_95$$62, "call_user_func", &_18, 238, &fileCheckingCallback, &filePath);
							zephir_check_call_status();
...
PHP_METHOD(Phalcon_Loader, loadFiles) {
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_6$$3, "call_user_func", &_7, 238, &fileCheckingCallback, &filePath);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_14$$7, "call_user_func", &_7, 238, &fileCheckingCallback, &filePath);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Loader, register) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_0)) {
		...
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 365, &_1$$3, &__$true, &_3$$3);
		zephir_check_call_status();
		if (1) {
...
PHP_METHOD(Phalcon_Loader, unregister) {
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		ZVAL_STRING(&_2$$3, "autoLoad");
		zephir_array_fast_append(&_1$$3, &_2$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_unregister", NULL, 366, &_1$$3);
		zephir_check_call_status();
		if (0) {
			zephir_update_property_zval(this_ptr, SL("registered"), &__$true);
		} else {
