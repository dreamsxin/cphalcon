...
PHP_METHOD(Phalcon_Debug_Dump, output) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		...
		ZEPHIR_CALL_FUNCTION(&_2$$4, "strtr", NULL, 82, &_3$$4, &_1$$4);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(variable) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(variable), _6$$4, _7$$4, _4$$4)
			{
				...
				ZVAL_LONG(&_8$$5, tab);
				ZEPHIR_CALL_FUNCTION(&_9$$5, "str_repeat", &_10, 174, &space, &_8$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_12$$5, "strtr", NULL, 82, &_13$$5, &_11$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_18$$5, this_ptr, "output", &_19, 200, &value, &_13$$5, &_8$$5);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZVAL_LONG(&_21$$7, tab);
					ZEPHIR_CALL_FUNCTION(&_22$$7, "str_repeat", &_10, 174, &space, &_21$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_24$$7, "strtr", NULL, 82, &_25$$7, &_23$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_30$$7, this_ptr, "output", &_19, 200, &value, &_25$$7, &_21$$7);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_33$$4, "str_repeat", &_10, 174, &space, &_32$$4);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_OBJECT) {
		...
		ZEPHIR_CALL_FUNCTION(&_35$$9, "strtr", NULL, 82, &_36$$9, &_34$$9);
		zephir_check_call_status();
		zephir_concat_self(&output, &_35$$9 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_37$$9, "get_parent_class", NULL, 201, variable);
		zephir_check_call_status();
		if (zephir_is_true(&_37$$9)) {
			...
			ZEPHIR_CALL_FUNCTION(&_39$$10, "get_parent_class", NULL, 201, variable);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_39$$10, "strtr", NULL, 82, &_40$$10, &_38$$10);
			zephir_check_call_status();
		...
		if (zephir_instance_of_ev(variable, phalcon_di_ce TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_44$$11, "str_repeat", &_10, 174, &space, &_43$$11);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_45$$11);
			ZEPHIR_CONCAT_VS(&_45$$11, &_44$$11, "[skipped]\n");
			zephir_concat_self(&output, &_45$$11 TSRMLS_CC);
		} else if (_42$$9) {
			ZEPHIR_CALL_FUNCTION(&_46$$12, "get_object_vars", NULL, 9, variable);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&_46$$12) == IS_ARRAY) {
				ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_46$$12), _49$$12, _50$$12, _47$$12)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_52$$13, "str_repeat", &_10, 174, &space, &_51$$13);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_54$$13, "strtr", NULL, 82, &_55$$13, &_53$$13);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_57$$13, this_ptr, "output", &_19, 200, &value, &_55$$13, &_51$$13);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_60$$14, "str_repeat", &_10, 174, &space, &_59$$14);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_62$$14, "strtr", NULL, 82, &_63$$14, &_61$$14);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&_65$$14, this_ptr, "output", &_19, 200, &value, &_63$$14, &_59$$14);
						zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &reflect$$15, "__construct", NULL, 132, variable);
			zephir_check_call_status();
			ZVAL_LONG(&_67$$15, ((256 | 512) | 1024));
			ZEPHIR_CALL_METHOD(&props$$15, &reflect$$15, "getproperties", NULL, 136, &_67$$15);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&props$$15) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&props$$15), _68$$15)
				{
					...
					ZEPHIR_CALL_FUNCTION(&_78$$16, "str_repeat", &_10, 174, &space, &_70$$16);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_80$$16, "strtr", NULL, 82, &_81$$16, &_79$$16);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_83$$16, this_ptr, "output", &_19, 200, &_84$$16, &_81$$16, &_70$$16);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_94$$17, "str_repeat", &_10, 174, &space, &_87$$17);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_96$$17, "strtr", NULL, 82, &_97$$17, &_95$$17);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&_99$$17, this_ptr, "output", &_19, 200, &_100$$17, &_97$$17, &_87$$17);
						zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&attr, "get_class_methods", NULL, 202, variable);
		zephir_check_call_status();
		ZVAL_LONG(&_103$$9, tab);
		ZEPHIR_CALL_FUNCTION(&_104$$9, "str_repeat", &_10, 174, &space, &_103$$9);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_106$$9, "strtr", NULL, 82, &_36$$9, &_105$$9);
		zephir_check_call_status();
		...
		if (zephir_fast_in_array(&_36$$9, &_103$$9 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_109$$18, "str_repeat", &_10, 174, &space, &_108$$18);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&attr) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&attr), _111$$19)
				{
					...
					if (ZEPHIR_IS_STRING(&value, "__construct")) {
						...
						ZEPHIR_CALL_FUNCTION(&_115$$21, "str_repeat", &_10, 174, &space, &_114$$21);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_117$$21, "strtr", NULL, 82, &_118$$21, &_116$$21);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_121$$22, "str_repeat", &_10, 174, &space, &_120$$22);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_FUNCTION(&_123$$22, "strtr", NULL, 82, &_124$$22, &_122$$22);
						zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						if (ZEPHIR_IS_STRING(&value, "__construct")) {
							...
							ZEPHIR_CALL_FUNCTION(&_128$$24, "str_repeat", &_10, 174, &space, &_127$$24);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_130$$24, "strtr", NULL, 82, &_131$$24, &_129$$24);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_134$$25, "str_repeat", &_10, 174, &space, &_133$$25);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_136$$25, "strtr", NULL, 82, &_137$$25, &_135$$25);
							zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&_140$$19, "str_repeat", &_10, 174, &space, &_139$$19);
			zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_143$$9, "str_repeat", &_10, 174, &space, &_142$$9);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_LONG) {
		...
		ZEPHIR_CALL_FUNCTION(&_145$$26, "strtr", NULL, 82, &_146$$26, &_144$$26);
		zephir_check_call_status();
		ZEPHIR_CONCAT_VV(return_value, &output, &_145$$26);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_147, "is_float", NULL, 203, variable);
	zephir_check_call_status();
	if (zephir_is_true(&_147)) {
		...
		ZEPHIR_CALL_FUNCTION(&_149$$27, "strtr", NULL, 82, &_150$$27, &_148$$27);
		zephir_check_call_status();
	...
	if (zephir_is_numeric(variable)) {
		...
		ZEPHIR_CALL_FUNCTION(&_152$$28, "strtr", NULL, 82, &_153$$28, &_151$$28);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_STRING) {
		...
		ZEPHIR_CALL_FUNCTION(&_155$$29, "htmlentities", NULL, 195, variable, &_157$$29, &_156$$29);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_158$$29, "nl2br", NULL, 204, &_155$$29);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_158$$29, "strtr", NULL, 82, &_156$$29, &_154$$29);
		zephir_check_call_status();
	...
	if ((Z_TYPE_P(variable) == IS_TRUE || Z_TYPE_P(variable) == IS_FALSE)) {
		...
		ZEPHIR_CALL_FUNCTION(&_160$$30, "strtr", NULL, 82, &_161$$30, &_159$$30);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(variable) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&_164$$31, "strtr", NULL, 82, &_165$$31, &_163$$31);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_167, "strtr", NULL, 82, &_168, &_166);
	zephir_check_call_status();
