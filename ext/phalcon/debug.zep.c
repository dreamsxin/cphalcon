...
PHP_METHOD(Phalcon_Debug, debugVar) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "debug_backtrace", NULL, 185);
...
PHP_METHOD(Phalcon_Debug, listenExceptions) {
	...
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 186, &_0);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, listenLowSeverity) {
	...
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(NULL, "set_error_handler", NULL, 76, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	...
	ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 186, &_2);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Phalcon_Debug, onUncaughtException) {
	...
	if (ZEPHIR_GT_LONG(&obLevel, 0)) {
		ZEPHIR_CALL_FUNCTION(NULL, "ob_end_clean", NULL, 188);
		zephir_check_call_status();
	}
	...
	if (zephir_is_true(&showBackTrace)) {
		...
		if (Z_TYPE_P(&_11$$5) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_11$$5), _14$$5, _15$$5, _12$$5)
			{
				...
				ZEPHIR_CALL_METHOD(&_16$$7, this_ptr, "showtraceitem", &_17, 189, &n, &traceItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_18$$8, this_ptr, "showtraceitem", &_17, 189, &n, &traceItem);
					zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_REQUEST), _25$$5, _26$$5, _23$$5)
			{
				...
				if (1 != zephir_array_isset(&blacklist, &_27$$9)) {
					if (Z_TYPE_P(&value) != IS_ARRAY) {
						...
						ZEPHIR_CALL_FUNCTION(&_29$$12, "print_r", &_30, 190, &value, &__$true);
						zephir_check_call_status();
				...
				zephir_check_call_status();
					...
					if (1 != zephir_array_isset(&blacklist, &_32$$13)) {
						if (Z_TYPE_P(&value) != IS_ARRAY) {
							...
							ZEPHIR_CALL_FUNCTION(&_34$$16, "print_r", &_30, 190, &value, &__$true);
							zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_49$$5, "get_included_files", NULL, 191);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_56$$5, "memory_get_usage", NULL, 192, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, onUncaughtLowSeverity) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "error_reporting", NULL, 193);
	zephir_check_call_status();
	ZEPHIR_SINIT_VAR(_1);
	...
	if (UNEXPECTED(zephir_is_true(&_1))) {
		...
		ZVAL_LONG(&_3$$3, 0);
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 194, message, &_3$$3, severity, file, line);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, escapeString) {
	...
	if (Z_TYPE_P(value) == IS_STRING) {
		...
		ZEPHIR_RETURN_CALL_FUNCTION("htmlentities", NULL, 195, &_0$$3, &_3$$3, &_4$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
	...
	if (Z_TYPE_P(&argument) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&argument), _3, _4, _1)
		{
			...
			if (ZEPHIR_IS_STRING(&v, "")) {
				...
				ZEPHIR_CALL_METHOD(&_6$$8, this_ptr, "getarraydump", &_8, 196, &v, &_7$$8);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&varDump);
		...
		while (1) {
			...
			zephir_check_call_status();
				if (ZEPHIR_IS_STRING(&v, "")) {
					...
					ZEPHIR_CALL_METHOD(&_11$$15, this_ptr, "getarraydump", &_8, 196, &v, &_12$$15);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&varDump);
...
PHP_METHOD(Phalcon_Debug, getVarDump) {
	...
	if (Z_TYPE_P(variable) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&_1$$10, this_ptr, "getarraydump", NULL, 196, variable);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Debug, showTraceItem) {
	...
	if (zephir_array_isset_string_fetch(&className, &trace, SL("class"), 0)) {
		...
		if (zephir_is_true(&_4$$3)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &classReflection, "__construct", NULL, 132, &className);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_8$$5, &classReflection, "isinternal", NULL, 197);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string(&trace, SL("class"))) {
		...
		if ((zephir_function_exists(&functionName TSRMLS_CC)  == SUCCESS)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &functionReflection, "__construct", NULL, 127, &functionName);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_14$$10, &functionReflection, "isinternal", NULL, 198);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&filez, &trace, SL("file"), 0)) {
		...
		if (zephir_is_true(&showFiles)) {
			ZEPHIR_CALL_FUNCTION(&lines, "file", NULL, 199, &filez);
			zephir_check_call_status();
			...
			while (1) {
				...
				if (_42$$25) {
					...
					ZEPHIR_CALL_FUNCTION(&_48$$30, "htmlentities", &_49, 195, &_43$$30, &_46$$30, &_47$$30);
					zephir_check_call_status();
