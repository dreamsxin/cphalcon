...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCallArgument) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getexpression", NULL, 415, &argument);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getCaseExpression) {
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (zephir_array_isset_string(&whenExpr, SL("right"))) {
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 415, &_5$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_4$$4, this_ptr, "_getexpression", &_6, 415, &_7$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$5, this_ptr, "_getexpression", &_6, 415, &_10$$5);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (zephir_array_isset_string(&whenExpr, SL("right"))) {
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 415, &_13$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_12$$7, this_ptr, "_getexpression", &_6, 415, &_14$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_16$$8, this_ptr, "_getexpression", &_6, 415, &_17$$8);
					zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_18, this_ptr, "_getexpression", &_6, 415, &_19);
	zephir_check_call_status();
		...
		if (zephir_array_isset_long(&arguments, 0)) {
			...
			if (Z_TYPE_P(&arguments) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&arguments), _0$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&_2$$7, this_ptr, "_getcallargument", &_3, 416, &argument);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_4$$8, this_ptr, "_getcallargument", &_3, 416, &argument);
						zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "_getcallargument", &_3, 416, &arguments);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getExpression) {
	...
	if (zephir_array_isset_string_fetch(&exprType, &expr, SL("type"), 0)) {
		...
		if (!ZEPHIR_IS_LONG(&exprType, 409)) {
			...
			if (zephir_array_isset_string_fetch(&exprLeft, &expr, SL("left"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&left, this_ptr, "_getexpression", NULL, 415, &exprLeft, &_0$$5);
				zephir_check_call_status();
			}
			...
			if (zephir_array_isset_string_fetch(&exprRight, &expr, SL("right"), 0)) {
				...
				ZEPHIR_CALL_METHOD(&right, this_ptr, "_getexpression", NULL, 415, &exprRight, &_1$$6);
				zephir_check_call_status();
			}
		}
		do {
			...
			if (ZEPHIR_IS_LONG(&exprType, 355)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getqualified", NULL, 417, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, '+')) {
			...
			if (ZEPHIR_IS_LONG(&exprType, 350)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getfunctioncall", NULL, 418, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 409)) {
				ZEPHIR_CALL_METHOD(&exprReturn, this_ptr, "_getcaseexpression", NULL, 419, &expr);
				zephir_check_call_status();
				break;
			}
			if (ZEPHIR_IS_LONG(&exprType, 309)) {
				...
				ZVAL_BOOL(&_82$$68, 1);
				ZEPHIR_CALL_METHOD(&_81$$68, this_ptr, "_prepareselect", NULL, 420, &expr, &_82$$68);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string(&expr, SL("domain"))) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_getqualified", NULL, 417, &expr);
		zephir_check_call_status();
		RETURN_MM();
	}
	if (zephir_array_isset_long(&expr, 0)) {
		...
		if (Z_TYPE_P(&expr) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _85$$71)
			{
				...
				ZEPHIR_CALL_METHOD(&_87$$72, this_ptr, "_getexpression", NULL, 415, &exprListItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_88$$73, this_ptr, "_getexpression", NULL, 415, &exprListItem);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSelectColumn) {
	...
	if (ZEPHIR_IS_LONG(&columnType, 352)) {
		...
		if (Z_TYPE_P(&_0$$4) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&_0$$4), _3$$4, _4$$4, _1$$4)
			{
				...
				ZEPHIR_CALL_FUNCTION(&_5$$5, "lcfirst", &_6, 84, &modelName);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_9$$7, "lcfirst", &_6, 84, &modelName);
					zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG(&columnType, 353)) {
		...
		if (Z_TYPE_P(&preparedAlias) != IS_STRING) {
			if (ZEPHIR_IS_EQUAL(&columnDomain, &modelName)) {
				ZEPHIR_CALL_FUNCTION(&preparedAlias, "lcfirst", &_6, 84, &modelName);
				zephir_check_call_status();
			} else {
	...
	if (ZEPHIR_IS_LONG(&columnType, 354)) {
		...
		ZEPHIR_CALL_METHOD(&sqlExprColumn, this_ptr, "_getexpression", NULL, 415, &columnData);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getSingleJoin) {
	...
	if (Z_TYPE_P(&fields) != IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 417, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_getqualified", NULL, 417, &_4$$3);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _7$$4, _8$$4, _5$$4)
			{
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 417, &_15$$5);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_14$$5, this_ptr, "_getqualified", NULL, 417, &_16$$5);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 417, &_22$$7);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_21$$7, this_ptr, "_getqualified", NULL, 417, &_23$$7);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&fields) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _3$$3, _4$$3, _1$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "_getqualified", &_11, 417, &_10$$4);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_9$$4, this_ptr, "_getqualified", &_11, 417, &_12$$4);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "_getqualified", &_11, 417, &_18$$6);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(&_17$$6, this_ptr, "_getqualified", &_11, 417, &_19$$6);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "_getqualified", &_11, 417, &_25$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "_getqualified", &_11, 417, &_26$$8);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "_getqualified", &_11, 417, &_27$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_23$$8, SL("left"), &_24$$8, PH_COPY | PH_SEPARATE);
		...
		ZEPHIR_CALL_METHOD(&_24$$8, this_ptr, "_getqualified", &_11, 417, &_28$$8);
		zephir_check_call_status();
		zephir_array_update_string(&_23$$8, SL("right"), &_24$$8, PH_COPY | PH_SEPARATE);
		zephir_array_fast_append(&_22$$8, &_23$$8);
		zephir_array_update_string(&_21$$8, SL("conditions"), &_22$$8, PH_COPY | PH_SEPARATE);
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getJoins) {
	...
	if (Z_TYPE_P(&selectJoins) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectJoins), _1)
		{
			...
			ZEPHIR_CALL_METHOD(&joinData, this_ptr, "_getjoin", &_3, 421, &manager, &joinItem);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&source);
			...
			ZEPHIR_CALL_METHOD(&joinType, this_ptr, "_getjointype", &_4, 422, &joinItem);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&joinPrepared) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&joinPrepared), _21, _22, _19)
		{
			...
			if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
				ZEPHIR_CALL_METHOD(&_23$$18, this_ptr, "_getexpression", &_24, 415, &joinExpr);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_OBS_NVAR(&joinExpr);
				if (zephir_array_isset_string_fetch(&joinExpr, &joinItem, SL("conditions"), 0)) {
					ZEPHIR_CALL_METHOD(&_25$$20, this_ptr, "_getexpression", &_24, 415, &joinExpr);
					zephir_check_call_status();
					...
					if (!(zephir_array_isset_fetch(&preCondition, &joinPreCondition, &joinAlias, 0 TSRMLS_CC))) {
						...
						if (Z_TYPE_P(&relation) == IS_OBJECT) {
							...
							if (!(zephir_is_true(&_55$$32))) {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getsinglejoin", &_56, 423, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							} else {
								ZEPHIR_CALL_METHOD(&sqlJoin, this_ptr, "_getmultijoin", &_57, 424, &joinType, &joinSource, &modelAlias, &joinAlias, &relation);
								zephir_check_call_status();
							}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getOrderClause) {
	...
	if (Z_TYPE_P(&orderColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&orderColumns), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 415, &_2$$5);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&orderPartExpr, this_ptr, "_getexpression", &_3, 415, &_8$$10);
				zephir_check_call_status();
	...
	if (zephir_array_isset_long(&group, 0)) {
		...
		if (Z_TYPE_P(&group) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&group), _0$$3)
			{
				...
				ZEPHIR_CALL_METHOD(&_2$$4, this_ptr, "_getexpression", &_3, 415, &groupItem);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_4$$5, this_ptr, "_getexpression", &_3, 415, &groupItem);
					zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_6$$6, this_ptr, "_getexpression", &_3, 415, &group);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getLimitClause) {
	...
	if (zephir_array_isset_string_fetch(&number, &limitClause, SL("number"), 0)) {
		ZEPHIR_CALL_METHOD(&_0$$3, this_ptr, "_getexpression", NULL, 415, &number);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&offset, &limitClause, SL("offset"), 0)) {
		ZEPHIR_CALL_METHOD(&_1$$4, this_ptr, "_getexpression", NULL, 415, &offset);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareSelect) {
	...
	if (zephir_fast_count_int(&joins TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(&sqlJoins, this_ptr, "_getjoins", NULL, 425, &select);
		zephir_check_call_status();
	} else {
		if (zephir_fast_count_int(&automaticJoins TSRMLS_CC)) {
			zephir_array_update_string(&select, SL("joins"), &automaticJoins, PH_COPY | PH_SEPARATE);
	...
	if (Z_TYPE_P(&selectColumns) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&selectColumns), _82)
		{
			...
			ZEPHIR_CALL_METHOD(&_84$$60, this_ptr, "_getselectcolumn", &_85, 426, &column);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_102$$77, this_ptr, "_getselectcolumn", &_85, 426, &column);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, ast, SL("where"), 0)) {
		ZEPHIR_CALL_METHOD(&_120$$96, this_ptr, "_getexpression", NULL, 415, &where);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&groupBy, ast, SL("groupBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_121$$97, this_ptr, "_getgroupclause", NULL, 427, &groupBy);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&having, ast, SL("having"), 0)) {
		ZEPHIR_CALL_METHOD(&_122$$98, this_ptr, "_getexpression", NULL, 415, &having);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&order, ast, SL("orderBy"), 0)) {
		ZEPHIR_CALL_METHOD(&_123$$99, this_ptr, "_getorderclause", NULL, 428, &order);
		zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&limit, ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_124$$100, this_ptr, "_getlimitclause", NULL, 429, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareInsert) {
	...
	if (Z_TYPE_P(&_2) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_2), _3)
		{
			...
			ZEPHIR_CALL_METHOD(&_7$$7, this_ptr, "_getexpression", &_9, 415, &exprValue, &_8$$7);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_12$$8, this_ptr, "_getexpression", &_9, 415, &exprValue, &_13$$8);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareUpdate) {
	...
	if (Z_TYPE_P(&updateValues) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&updateValues), _9)
		{
			...
			ZEPHIR_CALL_METHOD(&_11$$20, this_ptr, "_getexpression", &_14, 415, &_12$$20, &_13$$20);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&_17$$20, this_ptr, "_getexpression", &_14, 415, &exprColumn, &_18$$20);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_19$$21, this_ptr, "_getexpression", &_14, 415, &_20$$21, &_21$$21);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&_24$$21, this_ptr, "_getexpression", &_14, 415, &exprColumn, &_25$$21);
				zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_27$$22, 1);
		ZEPHIR_CALL_METHOD(&_26$$22, this_ptr, "_getexpression", &_14, 415, &where, &_27$$22);
		zephir_check_call_status();
		zephir_array_update_string(&sqlUpdate, SL("where"), &_26$$22, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_28$$23, this_ptr, "_getlimitclause", NULL, 429, &limit);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _prepareDelete) {
	...
	if (zephir_array_isset_string_fetch(&where, &ast, SL("where"), 0)) {
		ZVAL_BOOL(&_10$$17, 1);
		ZEPHIR_CALL_METHOD(&_9$$17, this_ptr, "_getexpression", NULL, 415, &where, &_10$$17);
		zephir_check_call_status();
		zephir_array_update_string(&sqlDelete, SL("where"), &_9$$17, PH_COPY | PH_SEPARATE);
	}
	ZEPHIR_OBS_VAR(&limit);
	if (zephir_array_isset_string_fetch(&limit, &ast, SL("limit"), 0)) {
		ZEPHIR_CALL_METHOD(&_11$$18, this_ptr, "_getlimitclause", NULL, 429, &limit);
		zephir_check_call_status();
		...
		if (zephir_array_isset_string_fetch(&type, &ast, SL("type"), 0)) {
			...
			do {
				if (ZEPHIR_IS_LONG(&type, 309)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareselect", NULL, 420);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 306)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareinsert", NULL, 430);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 300)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_prepareupdate", NULL, 431);
					zephir_check_call_status();
					break;
				}
				if (ZEPHIR_IS_LONG(&type, 303)) {
					ZEPHIR_CALL_METHOD(&irPhql, this_ptr, "_preparedelete", NULL, 432);
					zephir_check_call_status();
					break;
				}
	...
	if (!(isComplex)) {
		...
		if (_90$$83) {
			...
			if (zephir_is_true(&resultsetClassName)) {
				...
				ZEPHIR_CALL_FUNCTION(&_94$$97, "is_subclass_of", NULL, 408, &resultsetClassName, &_93$$97);
				zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 433, &simpleColumnMap, &resultObject, &resultData, &cache, &_100$$83);
		zephir_check_call_status();
		RETURN_MM();
	}
	object_init_ex(return_value, phalcon_mvc_model_resultset_complex_ce);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 434, &columns1, &resultData, &cache);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeInsert) {
	...
	if (Z_TYPE_P(&values) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&values), _4, _5, _2)
		{
			...
			do {
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &insertValue, "__construct", &_17, 24, &_15$$13);
				zephir_check_call_status();
				break;
			} while(0);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				do {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &insertValue, "__construct", &_17, 24, &_29$$22);
					zephir_check_call_status();
					break;
				} while(0);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_34, &insertModel);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeUpdate) {
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&fields), _4, _5, _2)
		{
			...
			do {
				...
				ZEPHIR_CALL_METHOD(&_15$$13, &dialect, "getsqlexpression", &_16, 0, &exprValue);
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, &updateValue, "__construct", &_17, 24, &_15$$13);
				zephir_check_call_status();
				break;
			} while(0);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				do {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(NULL, &updateValue, "__construct", &_17, 24, &_26$$22);
					zephir_check_call_status();
					break;
				} while(0);
	...
	ZEPHIR_INIT_NVAR(&field);
	ZEPHIR_INIT_NVAR(&number);
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 436, &model, &intermediate, &selectBindParams, &selectBindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_28$$23, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_28$$23);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, &bindParams, &bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_31$$24))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_33$$25, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_33$$25, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_35, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_35);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _executeDelete) {
	...
	ZEPHIR_CALL_METHOD(&records, this_ptr, "_getrelatedrecords", NULL, 436, &model, &intermediate, &bindParams, &bindTypes);
	zephir_check_call_status();
	if (!(zephir_fast_count_int(&records TSRMLS_CC))) {
		object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
		ZVAL_BOOL(&_2$$5, 1);
		ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_2$$5);
		zephir_check_call_status();
		RETURN_MM();
	}
	ZEPHIR_CALL_METHOD(&connection, this_ptr, "getwriteconnection", NULL, 0, &model, &intermediate, &bindParams, &bindTypes);
	...
	while (1) {
		...
		if (!(zephir_is_true(&_5$$6))) {
			...
			object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
			ZVAL_BOOL(&_7$$7, 0);
			ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_7$$7, &record);
			zephir_check_call_status();
			RETURN_MM();
		}
	...
	object_init_ex(return_value, phalcon_mvc_model_query_status_ce);
	ZVAL_BOOL(&_9, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 435, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, _getRelatedRecords) {
	...
	ZEPHIR_CALL_METHOD(NULL, &query, "__construct", NULL, 437);
	zephir_check_call_status();
	zephir_read_property(&_5, this_ptr, SL("container"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(NULL, &query, "setdi", NULL, 438, &_5);
	zephir_check_call_status();
	ZVAL_LONG(&_6, 309);
	ZEPHIR_CALL_METHOD(NULL, &query, "settype", NULL, 439, &_6);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &query, "setintermediate", NULL, 440, &selectIr);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_METHOD(&query, "execute", NULL, 441, &bindParams, &bindTypes);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, execute) {
	...
	do {
		if (ZEPHIR_IS_LONG(&type, 309)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeselect", NULL, 442, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 306)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeinsert", NULL, 443, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 300)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executeupdate", NULL, 444, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
		if (ZEPHIR_IS_LONG(&type, 303)) {
			ZEPHIR_CALL_METHOD(&result, this_ptr, "_executedelete", NULL, 445, &intermediate, &mergedParams, &mergedTypes);
			zephir_check_call_status();
			break;
		}
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSingleResult) {
	...
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "execute", NULL, 441, &bindParams, &bindTypes);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Query, getSql) {
	...
	if (ZEPHIR_IS_LONG(&_0, 309)) {
		...
		ZVAL_BOOL(&_3$$3, 1);
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "_executeselect", NULL, 442, &intermediate, &_1$$3, &_2$$3, &_3$$3);
		zephir_check_call_status();
		RETURN_MM();
	}
