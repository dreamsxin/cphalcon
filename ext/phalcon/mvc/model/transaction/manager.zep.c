...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, get) {
	...
	if (!(zephir_is_true(&_0))) {
		...
		if (zephir_is_true(&_1$$3)) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "register_shutdown_function", NULL, 451, &_2$$4);
			zephir_check_call_status();
		}
		if (1) {
...
PHP_METHOD(Phalcon_Mvc_Model_Transaction_Manager, getOrCreateTransaction) {
	...
	ZEPHIR_CALL_METHOD(NULL, &transaction, "__construct", NULL, 452, &container, &_11, &_10);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &transaction, "settransactionmanager", NULL, 453, this_ptr);
	zephir_check_call_status();
