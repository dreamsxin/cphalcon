...
PHP_METHOD(Phalcon_Mvc_Model_Manager, isVisibleModelProperty) {
	...
	if (!(zephir_array_isset(&_0, &className))) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "get_object_vars", NULL, 9, model);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasOne) {
	...
	ZVAL_LONG(&_2, 1);
	ZEPHIR_CALL_METHOD(NULL, &relation, "__construct", NULL, 411, &_2, &referencedModel, fields, referencedFields, options);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasMany) {
	...
	object_init_ex(&relation, phalcon_mvc_model_relation_ce);
	ZVAL_LONG(&_1, 2);
	ZEPHIR_CALL_METHOD(NULL, &relation, "__construct", NULL, 411, &_1, &referencedModel, fields, referencedFields, options);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&alias);
	if (zephir_array_isset_string_fetch(&alias, options, SL("alias"), 0)) {
		if (UNEXPECTED(Z_TYPE_P(&alias) != IS_STRING)) {
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, addHasManyToMany) {
	...
	ZEPHIR_CALL_METHOD(NULL, &relation, "__construct", NULL, 411, &_1, &referencedModel, fields, referencedFields, options);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &relation, "setintermediaterelation", NULL, 412, intermediateFields, &intermediateModel, intermediateReferencedFields);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(&alias);
	if (zephir_array_isset_string_fetch(&alias, options, SL("alias"), 0)) {
...
PHP_METHOD(Phalcon_Mvc_Model_Manager, getRelationRecords) {
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(&_5$$3, this_ptr, "_mergefindparameters", NULL, 413, &extraParameters, parameters);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&findArguments, this_ptr, "_mergefindparameters", NULL, 413, &findParams, parameters);
	zephir_check_call_status();
	if (Z_TYPE_P(&extraParameters) == IS_ARRAY) {
		ZEPHIR_CALL_METHOD(&findParams, this_ptr, "_mergefindparameters", NULL, 413, &extraParameters, &findArguments);
		zephir_check_call_status();
	} else {
