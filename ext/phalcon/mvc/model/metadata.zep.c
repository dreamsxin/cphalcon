...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getAttributes) {
	...
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_METHOD(&data, this_ptr, "readmetadataindex", NULL, 13, model, &_0);
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getColumnMap) {
	...
	ZVAL_LONG(&_0, 0);
	ZEPHIR_CALL_METHOD(&data, this_ptr, "readcolumnmapindex", NULL, 14, model, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, getIdentityField) {
	...
	ZVAL_LONG(&_0, 8);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "readmetadataindex", NULL, 13, model, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, hasAttribute) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "readmetadata", NULL, 15, model);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readColumnMap) {
	...
	if (!(zephir_array_isset_fetch(&data, &_0, &keyName, 0 TSRMLS_CC))) {
		...
		ZVAL_NULL(&_2$$4);
		ZVAL_NULL(&_3$$4);
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "initialize", NULL, 16, model, &_1$$4, &_2$$4, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, readMetaData) {
	...
	if (!(zephir_array_isset(&_2, &key))) {
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "initialize", NULL, 16, model, &key, &source, &schema);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, setAutomaticCreateAttributes) {
	...
	ZVAL_LONG(&_0, 10);
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "writemetadataindex", NULL, 17, model, &_0, &attributes);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Model_MetaData, write) {
	...
	/* try_start_1: */
		...
		if (ZEPHIR_IS_FALSE_IDENTICAL(&result)) {
			ZEPHIR_CALL_METHOD(NULL, this_ptr, "throwwriteexception", NULL, 18, &option);
			zephir_check_call_status_or_jump(try_end_1);
		}
