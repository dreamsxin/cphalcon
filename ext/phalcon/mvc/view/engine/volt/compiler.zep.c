...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, attributeReader) {
	...
	if (ZEPHIR_IS_LONG(&_0, 265)) {
		...
		ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", NULL, 464, &left);
		zephir_check_call_status();
	...
	if (ZEPHIR_IS_LONG(&_10, 265)) {
		...
		ZEPHIR_CALL_METHOD(&_12$$12, this_ptr, "expression", NULL, 464, &right);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compile) {
	...
	if (Z_TYPE_P(&compiledPath) == IS_STRING) {
		if (!(ZEPHIR_IS_EMPTY(&compiledPath))) {
			ZEPHIR_CALL_FUNCTION(&_10$$22, "realpath", NULL, 83, &templatePath);
			zephir_check_call_status();
			...
			if (zephir_compare_mtime(&templatePath, &compiledTemplatePath TSRMLS_CC)) {
				...
				if (extendsMode) {
					...
					if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&blocksCode))) {
						...
						ZEPHIR_CALL_METHOD(NULL, &_17$$35, "__construct", NULL, 465, &_18$$35);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileAutoEscape) {
	...
	ZEPHIR_CALL_METHOD(&compilation, this_ptr, "statementlist", NULL, 466, &_0, &_1);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileCache) {
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 465, &_1$$3, &statement);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_0$$3, "phalcon/Mvc/View/Engine/Volt/Compiler.zep", 430 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", NULL, 464, &expr);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "expression", NULL, 464, &expr);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
	...
	ZEPHIR_CALL_METHOD(&_12, this_ptr, "statementlist", NULL, 466, &_13, &_14);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileCase) {
	...
	if (UNEXPECTED(!(zephir_array_isset_string_fetch(&expr, &statement, SL("expr"), 0)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 465, &_1$$4, &statement);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileDo) {
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "expression", NULL, 464, &expr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileFile) {
	...
	if (UNEXPECTED(!((zephir_file_exists(&path TSRMLS_CC) == SUCCESS)))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 465, &_1$$4);
		zephir_check_call_status();
	...
	if (UNEXPECTED(ZEPHIR_IS_FALSE_IDENTICAL(&viewCode))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", NULL, 465, &_3$$5);
		zephir_check_call_status();
	...
	if (Z_TYPE_P(&compilation) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&finalCompilation, "serialize", NULL, 20, &compilation);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileForeach) {
	...
	ZEPHIR_CALL_METHOD(&code, this_ptr, "statementlist", NULL, 466, &blockStatements, &_4);
	zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&ifExpr, &statement, SL("if_expr"), 0)) {
		ZEPHIR_CALL_METHOD(&_16$$15, this_ptr, "expression", NULL, 464, &ifExpr);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileIf) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "statementlist", NULL, 466, &_4, &_5);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_6);
	...
	if (zephir_array_isset_string_fetch(&blockStatements, &statement, SL("false_statements"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&_7$$4, this_ptr, "statementlist", NULL, 466, &blockStatements, &_8$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileInclude) {
	...
	ZEPHIR_CALL_METHOD(&path, this_ptr, "expression", NULL, 464, &pathExpr);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "expression", NULL, 464, &params);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileMacro) {
	...
	if (UNEXPECTED(zephir_array_isset(&_0, &name))) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$4, "__construct", NULL, 465, &_2$$4);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&parameters) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&parameters), _8$$6, _9$$6, _6$$6)
			{
				...
				if (EXPECTED(zephir_array_isset_string_fetch(&defaultValue, &parameter, SL("default"), 0))) {
					ZEPHIR_CALL_METHOD(&_14$$8, this_ptr, "expression", &_15, 464, &defaultValue);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					ZEPHIR_OBS_NVAR(&defaultValue);
					if (EXPECTED(zephir_array_isset_string_fetch(&defaultValue, &parameter, SL("default"), 0))) {
						ZEPHIR_CALL_METHOD(&_22$$11, this_ptr, "expression", &_15, 464, &defaultValue);
						zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&blockStatements, &statement, SL("block_statements"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&_25$$13, this_ptr, "statementlist", NULL, 466, &blockStatements, &_26$$13);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSet) {
	...
	if (Z_TYPE_P(&assignments) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&assignments), _0)
		{
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_3, 464, &_2$$4);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_3, 464, &_4$$4);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "expression", &_3, 464, &_11$$10);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(&target, this_ptr, "expression", &_3, 464, &_12$$10);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSwitch) {
	...
	if (zephir_array_isset_string_fetch(&caseClauses, &statement, SL("case_clauses"), 0)) {
		...
		ZEPHIR_CALL_METHOD(&lines, this_ptr, "statementlist", NULL, 466, &caseClauses, &_3$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, expression) {
	...
	while (1) {
		if (Z_TYPE_P(&extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "fireextensionevent", &_3, 467, &_2$$4, &_1$$4);
			zephir_check_call_status();
		...
		if (!(zephir_array_isset_string_fetch(&type, &expr, SL("type"), 0))) {
			...
			if (Z_TYPE_P(&expr) == IS_ARRAY) {
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&expr), _4$$6)
				{
					...
					ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_7, 464, &_6$$7);
					zephir_check_call_status();
				...
				while (1) {
					...
					zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(&singleExprCode, this_ptr, "expression", &_7, 464, &_9$$10);
						zephir_check_call_status();
						ZEPHIR_OBS_NVAR(&name);
						if (zephir_array_isset_string_fetch(&name, &singleExpr, SL("name"), 0)) {
		...
		if (zephir_array_isset_string_fetch(&left, &expr, SL("left"), 0)) {
			ZEPHIR_CALL_METHOD(&leftCode, this_ptr, "expression", &_7, 464, &left);
			zephir_check_call_status();
		}
		...
		if (ZEPHIR_IS_LONG(&type, 124)) {
			...
			ZEPHIR_CALL_METHOD(&exprCode, this_ptr, "resolvefilter", &_15, 468, &_14$$16, &leftCode);
			zephir_check_call_status();
			break;
		}
		ZEPHIR_OBS_NVAR(&right);
		if (zephir_array_isset_string_fetch(&right, &expr, SL("right"), 0)) {
			ZEPHIR_CALL_METHOD(&rightCode, this_ptr, "expression", &_7, 464, &right);
			zephir_check_call_status();
		}
		ZEPHIR_INIT_NVAR(&exprCode);
		ZVAL_NULL(&exprCode);
		do {
			...
			if (ZEPHIR_IS_LONG(&type, 365)) {
				...
				if (zephir_array_isset_string_fetch(&start, &expr, SL("start"), 0)) {
					ZEPHIR_CALL_METHOD(&startCode, this_ptr, "expression", &_7, 464, &start);
					zephir_check_call_status();
				} else {
				...
				if (zephir_array_isset_string_fetch(&end, &expr, SL("end"), 0)) {
					ZEPHIR_CALL_METHOD(&endCode, this_ptr, "expression", &_7, 464, &end);
					zephir_check_call_status();
				} else {
			...
			if (ZEPHIR_IS_LONG(&type, 366)) {
				...
				ZEPHIR_CALL_METHOD(&_22$$72, this_ptr, "expression", &_7, 464, &_23$$72);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&exprCode);
			...
			ZEPHIR_CALL_METHOD(NULL, &_24$$76, "__construct", &_28, 465, &_27$$76);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, functionCall) {
	...
	if (zephir_array_isset_string_fetch(&funcArguments, &expr, SL("arguments"), 0)) {
		ZEPHIR_CALL_METHOD(&arguments, this_ptr, "expression", NULL, 464, &funcArguments);
		zephir_check_call_status();
	} else {
	...
	if (ZEPHIR_IS_LONG(&nameType, 265)) {
		...
		if (Z_TYPE_P(&extensions) == IS_ARRAY) {
			...
			ZEPHIR_CALL_METHOD(&code, this_ptr, "fireextensionevent", NULL, 467, &_2$$6, &_1$$6);
			zephir_check_call_status();
		...
		if (Z_TYPE_P(&functions) == IS_ARRAY) {
			...
			if (zephir_array_isset_fetch(&definition, &functions, &name, 0 TSRMLS_CC)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_4$$9, "__construct", NULL, 465, &_7$$9);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&extendedBlocks) == IS_ARRAY) {
				...
				if (zephir_array_isset_fetch(&block, &extendedBlocks, &currentBlock, 0 TSRMLS_CC)) {
					...
					if (Z_TYPE_P(&block) == IS_ARRAY) {
						ZEPHIR_CALL_METHOD(&code, this_ptr, "statementlistorextends", NULL, 469, &block);
						zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&method, "lcfirst", NULL, 84, &_12$$5);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_14, this_ptr, "expression", NULL, 464, &nameExpr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveTest) {
	...
	if (ZEPHIR_IS_LONG(&type, 350)) {
		...
		if (zephir_array_isset_string_fetch(&name, &testName, SL("value"), 0)) {
			if (ZEPHIR_IS_STRING(&name, "divisibleby")) {
				...
				ZEPHIR_CALL_METHOD(&_0$$12, this_ptr, "expression", NULL, 464, &_1$$12);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_STRING(&name, "sameas")) {
				...
				ZEPHIR_CALL_METHOD(&_2$$13, this_ptr, "expression", NULL, 464, &_3$$13);
				zephir_check_call_status();
			...
			if (ZEPHIR_IS_STRING(&name, "type")) {
				...
				ZEPHIR_CALL_METHOD(&_4$$14, this_ptr, "expression", NULL, 464, &_5$$14);
				zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "expression", NULL, 464, &test);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, compileSource) {
	...
	ZEPHIR_CALL_METHOD(&compilation, this_ptr, "statementlist", NULL, 466, &intermediate, &_0);
	zephir_check_call_status();
			...
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&extendedBlocks), _5$$7, _6$$7, _3$$7)
			{
				...
				if (Z_TYPE_P(&name) == IS_STRING) {
					if (zephir_array_isset(&blocks, &name)) {
						...
						ZEPHIR_CALL_METHOD(&blockCompilation, this_ptr, "statementlist", NULL, 466, &localBlock);
						zephir_check_call_status();
					} else {
						if (Z_TYPE_P(&block) == IS_ARRAY) {
							ZEPHIR_CALL_METHOD(&blockCompilation, this_ptr, "statementlist", NULL, 466, &block);
							zephir_check_call_status();
						} else {
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, resolveFilter) {
	...
	if (ZEPHIR_IS_LONG(&type, 265)) {
		...
		if (UNEXPECTED(!ZEPHIR_IS_LONG(&type, 350))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_0$$5, "__construct", NULL, 465, &_3$$5);
			zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&funcArguments, &filter, SL("arguments"), 0)) {
		if (!ZEPHIR_IS_STRING(&name, "default")) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 470, &funcArguments, &_4$$7);
	...
	if (Z_TYPE_P(&extensions) == IS_ARRAY) {
		...
		ZEPHIR_CALL_METHOD(&code, this_ptr, "fireextensionevent", NULL, 467, &_8$$9, &_7$$9);
		zephir_check_call_status();
		if (Z_TYPE_P(&code) == IS_STRING) {
			RETURN_CCTOR(&code);
		}
	...
	if (zephir_array_isset_fetch(&definition, &filters, &name, 0 TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_10$$11, "__construct", NULL, 465, &_13$$11);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(NULL, &_17, "__construct", NULL, 465, &_20);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&statements) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&statements), _2)
		{
			...
			if (UNEXPECTED(!(zephir_array_isset_string(&statement, SL("type"))))) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_4$$7, "__construct", &_8, 465, &_7$$7, &statement);
				zephir_check_call_status();
			...
			if (Z_TYPE_P(&extensions) == IS_ARRAY) {
				...
				ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_11, 467, &_10$$8, &_9$$8);
				zephir_check_call_status();
			...
			do {
				...
				if (ZEPHIR_IS_LONG(&type, 307)) {
					...
					if (zephir_is_true(&blockMode)) {
						...
						if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
							...
							ZEPHIR_CALL_METHOD(&_33$$24, this_ptr, "statementlist", &_35, 466, &blockStatements, &_34$$24);
							zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_59$$38, "__construct", &_8, 465, &_62$$38);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (UNEXPECTED(!(zephir_array_isset_string(&statement, SL("type"))))) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_63$$41, "__construct", &_8, 465, &_66$$41, &statement);
					zephir_check_call_status();
				...
				if (Z_TYPE_P(&extensions) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&tempCompilation, this_ptr, "fireextensionevent", &_11, 467, &_68$$42, &_67$$42);
					zephir_check_call_status();
					if (Z_TYPE_P(&tempCompilation) == IS_STRING) {
						zephir_concat_self(&compilation, &tempCompilation TSRMLS_CC);
						continue;
				...
				do {
					...
					if (ZEPHIR_IS_LONG(&type, 307)) {
						...
						if (zephir_is_true(&blockMode)) {
							...
							if (Z_TYPE_P(&blockStatements) == IS_ARRAY) {
								...
								ZEPHIR_CALL_METHOD(&_83$$58, this_ptr, "statementlist", &_35, 466, &blockStatements, &_84$$58);
								zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &_99$$72, "__construct", &_8, 465, &_102$$72);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_View_Engine_Volt_Compiler, statementListOrExtends) {
	...
	if (isStatementList) {
		ZEPHIR_RETURN_CALL_METHOD(this_ptr, "statementlist", NULL, 466, statements);
		zephir_check_call_status();
		RETURN_MM();
	}
	RETVAL_ZVAL(statements, 1, 0);
