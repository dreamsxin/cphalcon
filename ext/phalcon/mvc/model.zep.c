...
PHP_METHOD(Phalcon_Mvc_Model, __call) {
	...
	ZEPHIR_CALL_SELF(&records, "_invokefinder", &_0, 389, &method, &arguments);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, __callStatic) {
	...
	ZEPHIR_RETURN_CALL_SELF("_invokefinder", &_0, 389, &method, &arguments);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model, __set) {
	...
	ZEPHIR_CALL_METHOD(&_13, this_ptr, "_possiblesetter", NULL, 390, &property, value);
	zephir_check_call_status();
	if (zephir_is_true(&_13)) {
		RETVAL_ZVAL(value, 1, 0);
		RETURN_MM();
	}
	ZEPHIR_CALL_FUNCTION(&_14, "property_exists", NULL, 391, this_ptr, &property);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, assign) {
	...
	if (Z_TYPE_P(&_4) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_4), _5)
		{
			...
			if (_7$$12) {
				ZEPHIR_CALL_SELF(&_8$$13, "caseinsensitivecolumnmap", &_9, 392, &columnMap, &attribute);
				zephir_check_call_status();
			...
			if (zephir_array_isset_fetch(&value, &dataMapped, &attributeField, 0 TSRMLS_CC)) {
				...
				if (!(_13$$18)) {
					ZEPHIR_CALL_METHOD(&_14$$18, this_ptr, "_possiblesetter", &_15, 390, &attributeField, &value);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_16$$22) {
					ZEPHIR_CALL_SELF(&_17$$23, "caseinsensitivecolumnmap", &_9, 392, &columnMap, &attribute);
					zephir_check_call_status();
				...
				if (zephir_array_isset_fetch(&value, &dataMapped, &attributeField, 0 TSRMLS_CC)) {
					...
					if (!(_20$$28)) {
						ZEPHIR_CALL_METHOD(&_21$$28, this_ptr, "_possiblesetter", &_15, 390, &attributeField, &value);
						zephir_check_call_status();
			...
			if (_8$$3) {
				...
				do {
					if (ZEPHIR_IS_LONG(&_9$$9, 0)) {
						ZVAL_LONG(&_10$$10, 10);
						ZEPHIR_CALL_FUNCTION(&castValue, "intval", &_11, 41, &value, &_10$$10);
						zephir_check_call_status();
						break;
					}
				...
				if (_15$$17) {
					...
					do {
						if (ZEPHIR_IS_LONG(&_16$$23, 0)) {
							ZVAL_LONG(&_17$$24, 10);
							ZEPHIR_CALL_FUNCTION(&castValue, "intval", &_11, 41, &value, &_17$$24);
							zephir_check_call_status();
							break;
						}
...
PHP_METHOD(Phalcon_Mvc_Model, cloneResultMapHydrate) {
	...
	if (Z_TYPE_P(&data) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _2, _3, _0)
		{
			...
			if (Z_TYPE_P(columnMap) == IS_ARRAY) {
				...
				if (_4$$7) {
					ZEPHIR_CALL_SELF(&_5$$8, "caseinsensitivecolumnmap", &_6, 392, columnMap, &key);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(columnMap) == IS_ARRAY) {
					...
					if (_10$$16) {
						ZEPHIR_CALL_SELF(&_11$$17, "caseinsensitivecolumnmap", &_6, 392, columnMap, &key);
						zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&key);
	if (hydrationMode != 1) {
		ZEPHIR_RETURN_CALL_CE_STATIC(phalcon_helper_arr_ce, "arraytoobject", &_14, 393, &hydrateArray);
		zephir_check_call_status();
		RETURN_MM();
	}
...
PHP_METHOD(Phalcon_Mvc_Model, create) {
	...
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_1, this_ptr, "getreadconnection", NULL, 394);
	zephir_check_call_status();
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 376, &_4$$3, &_5$$3, &_6$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, delete) {
	...
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&writeConnection, this_ptr, "getwriteconnection", NULL, 395);
	zephir_check_call_status();
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "_checkforeignkeysreverserestrict", NULL, 396);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&schema, this_ptr, "getschema", NULL, 397);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&source, this_ptr, "getsource", NULL, 398);
	zephir_check_call_status();
	...
	zephir_check_call_status();
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_28$$25, this_ptr, "_checkforeignkeysreversecascade", NULL, 399);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, dump) {
	...
	ZEPHIR_RETURN_CALL_FUNCTION("get_object_vars", NULL, 9, this_ptr);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model, find) {
	...
	ZEPHIR_CALL_STATIC(&query, "getpreparedquery", &_0, 400, &params);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, findFirst) {
	...
	ZVAL_LONG(&_3, 1);
	ZEPHIR_CALL_STATIC(&query, "getpreparedquery", &_2, 400, &params, &_3);
	zephir_check_call_status();
	ZVAL_BOOL(&_3, 1);
...
PHP_METHOD(Phalcon_Mvc_Model, hasChanged) {
	...
	if (Z_TYPE_P(fieldName) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&intersect, "array_intersect", NULL, 227, fieldName, &changedFields);
		zephir_check_call_status();
		if (allFields) {
...
PHP_METHOD(Phalcon_Mvc_Model, hasUpdated) {
	...
	if (Z_TYPE_P(fieldName) == IS_ARRAY) {
		ZEPHIR_CALL_FUNCTION(&intersect, "array_intersect", NULL, 227, fieldName, &updatedFields);
		zephir_check_call_status();
		if (allFields) {
			RETURN_MM_BOOL(ZEPHIR_IS_EQUAL(&intersect, fieldName));
		}
...
PHP_METHOD(Phalcon_Mvc_Model, query) {
	...
	if (zephir_instance_of_ev(container, phalcon_diinterface_ce TSRMLS_CC)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &criteria, "setdi", NULL, 401, container);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_3);
	zephir_get_called_class(&_3 TSRMLS_CC);
	ZEPHIR_CALL_METHOD(NULL, &criteria, "setmodelname", NULL, 402, &_3);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, refresh) {
	...
	ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&readConnection, this_ptr, "getreadconnection", NULL, 394);
	zephir_check_call_status();
	zephir_read_property(&_1, this_ptr, SL("modelsManager"), PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Phalcon_Mvc_Model, save) {
	...
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_5)) {
		...
		if (UNEXPECTED(ZEPHIR_GLOBAL(orm).exception_on_failed_save)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_7$$11, "__construct", NULL, 403, this_ptr, &_8$$11);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, serialize) {
	...
	if (zephir_is_true(&_0)) {
		...
		if (_2$$3) {
			...
			ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 20, &_3$$4);
			zephir_check_call_status();
			RETURN_MM();
		}
	}
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 20, &attributes);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Model, unserialize) {
	...
	ZEPHIR_CALL_FUNCTION(&attributes, "unserialize", NULL, 21, data);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(columnMap) == IS_ARRAY) {
		...
		if (Z_TYPE_P(&data) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&data), _2$$3, _3$$3, _0$$3)
			{
				...
				if (_4$$4) {
					ZEPHIR_CALL_SELF(&_5$$6, "caseinsensitivecolumnmap", &_6, 392, columnMap, &key);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_12$$12) {
						ZEPHIR_CALL_SELF(&_13$$14, "caseinsensitivecolumnmap", &_6, 392, columnMap, &key);
						zephir_check_call_status();
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _1)
		{
			...
			if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
				...
				if (_3$$4) {
					ZEPHIR_CALL_SELF(&_4$$5, "caseinsensitivecolumnmap", &_5, 392, &columnMap, &attribute);
					zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				if (Z_TYPE_P(&columnMap) == IS_ARRAY) {
					...
					if (_9$$14) {
						ZEPHIR_CALL_SELF(&_10$$15, "caseinsensitivecolumnmap", &_5, 392, &columnMap, &attribute);
						zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, update) {
	...
	if (zephir_is_true(&_0)) {
		ZEPHIR_CALL_METHOD(&metaData, this_ptr, "getmodelsmetadata", NULL, 0);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&_2$$3, this_ptr, "getreadconnection", NULL, 394);
		zephir_check_call_status();
		...
		if (!(zephir_is_true(&_1$$3))) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_4$$4, "__construct", NULL, 376, &_5$$4, &_6$$4, &_7$$4);
			zephir_check_call_status();
	...
	if (Z_TYPE_P(&belongsTo) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&belongsTo), _1)
		{
			...
			if (_15$$3) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_20$$18, "__construct", &_22, 376, &message, &fields, &_21$$18);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (_36$$22) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_41$$37, "__construct", &_22, 376, &message, &fields, &_42$$37);
					zephir_check_call_status();
	...
	if (Z_TYPE_P(&relations) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&relations), _1)
		{
			...
			if (zephir_is_true(&_15$$3)) {
				...
				ZEPHIR_CALL_METHOD(NULL, &_18$$12, "__construct", &_20, 376, &message, &fields, &_19$$12);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_34$$14)) {
					...
					ZEPHIR_CALL_METHOD(NULL, &_37$$23, "__construct", &_20, 376, &message, &fields, &_38$$23);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, _doLowInsert) {
	...
	if (_34) {
		...
		if (UNEXPECTED(ZEPHIR_GLOBAL(orm).cast_last_insert_id_to_int)) {
			ZVAL_LONG(&_36$$50, 10);
			ZEPHIR_CALL_FUNCTION(&_37$$50, "intval", NULL, 41, &lastInsertedId, &_36$$50);
			zephir_check_call_status();
								...
								if (Z_TYPE_P(&snapshotValue) == IS_NULL) {
									...
									do {
										...
										if (ZEPHIR_IS_LONG(&dataType, 3) || ZEPHIR_IS_LONG(&dataType, 7)) {
											ZEPHIR_CALL_FUNCTION(&_11$$24, "floatval", &_12, 404, &snapshotValue);
											zephir_check_call_status();
											ZEPHIR_CALL_FUNCTION(&_13$$24, "floatval", &_12, 404, &value);
											zephir_check_call_status();
								...
								if (Z_TYPE_P(&value) == IS_NULL) {
									...
									if (Z_TYPE_P(&snapshotValue) == IS_NULL) {
										...
										do {
											...
											if (ZEPHIR_IS_LONG(&dataType, 3) || ZEPHIR_IS_LONG(&dataType, 7)) {
												ZEPHIR_CALL_FUNCTION(&_22$$46, "floatval", &_12, 404, &snapshotValue);
												zephir_check_call_status();
												ZEPHIR_CALL_FUNCTION(&_23$$46, "floatval", &_12, 404, &value);
												zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, _invokeFinder) {
	...
	if (zephir_array_isset(&attributes, &extraMethod)) {
		...
		ZEPHIR_CALL_FUNCTION(&extraMethodFirst, "lcfirst", NULL, 84, &extraMethod);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, _preSave) {
	...
	if (ZEPHIR_GLOBAL(orm).virtual_foreign_keys) {
		ZEPHIR_CALL_METHOD(&_3$$8, this_ptr, "_checkforeignkeysrestrict", NULL, 405);
		zephir_check_call_status();
				...
				ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&notNull), _4$$11)
				{
					...
					if (!(zephir_array_isset(&automaticAttributes, &attributeField))) {
						...
						if (isNull) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_13$$31, "__construct", &_16, 376, &_14$$31, &attributeField, &_15$$31);
							zephir_check_call_status();
					...
					zephir_check_call_status();
						...
						if (!(zephir_array_isset(&automaticAttributes, &attributeField))) {
							...
							if (isNull) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_23$$50, "__construct", &_16, 376, &_24$$50, &attributeField, &_25$$50);
								zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Model, validate) {
	...
	for (;_1->funcs->valid(_1 TSRMLS_CC) == SUCCESS && !EG(exception); _1->funcs->move_forward(_1 TSRMLS_CC)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", &_7, 376, &_3$$4, &_4$$4, &_5$$4, &_6$$4);
		zephir_check_call_status();
