...
PHP_METHOD(Phalcon_Mvc_Collection, create) {
	...
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "presave", NULL, 378, &_0, &_3, &_4);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 379, &_7, &_8, &_9);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, createIfNotExist) {
	...
	ZEPHIR_CALL_FUNCTION(&keys, "array_flip", NULL, 151, &criteria);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&data, this_ptr, "toarray", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_5, "array_diff_key", NULL, 380, &keys, &data);
	zephir_check_call_status();
	...
	if (Z_TYPE_P(&status) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_11$$8, "__construct", NULL, 376, &_12$$8);
		zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 379, &_8, &_13, &_14);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, save) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "presave", NULL, 378, &_4, &_5, &exists);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 379, &_8, &_9, &exists);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, serialize) {
	...
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("serialize", NULL, 20, &_6);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, toArray) {
	...
	array_init(&data);
	ZEPHIR_CALL_FUNCTION(&_0, "get_object_vars", NULL, 9, this_ptr);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, update) {
	...
	zephir_read_property(&_0, this_ptr, SL("container"), PH_NOISY_CC | PH_READONLY);
	zephir_read_static_property_ce(&_3, phalcon_mvc_collection_ce, SL("disableEvents"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "presave", NULL, 378, &_0, &_3, &exists);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE_IDENTICAL(&_2)) {
		RETURN_MM_BOOL(0);
	}
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "postsave", NULL, 379, &_7, &_8, &exists);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Collection, validate) {
	...
	for (;_1->funcs->valid(_1 TSRMLS_CC) == SUCCESS && !EG(exception); _1->funcs->move_forward(_1 TSRMLS_CC)) {
		...
		zephir_check_call_status();
		ZVAL_NULL(&_7$$4);
		ZEPHIR_CALL_METHOD(NULL, &_2$$4, "__construct", &_8, 376, &_3$$4, &_4$$4, &_5$$4, &_7$$4, &_6$$4);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Mvc_Collection, getResultset) {
	...
	ZEPHIR_CALL_FUNCTION(&_6, "iterator_to_array", NULL, 381, &documentsCursor, &__$false);
	zephir_check_call_status();
