...
PHP_METHOD(Phalcon_Mvc_Micro, getService) {
	...
	if (Z_TYPE_P(&container) != IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(NULL, &container, "__construct", NULL, 382);
		zephir_check_call_status();
		zephir_update_property_zval(this_ptr, SL("container"), &container);
	}
	ZEPHIR_RETURN_CALL_METHOD(&container, "get", NULL, 383, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, getSharedService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "getshared", NULL, 384, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, hasService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "has", NULL, 385, &serviceName);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Mvc_Micro, mount) {
	...
	if (zephir_is_true(&_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &lazyHandler, "__construct", NULL, 386, &mainHandler);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Phalcon_Mvc_Micro, offsetUnset) {
	...
	ZEPHIR_CALL_METHOD(NULL, &container, "remove", NULL, 387, alias);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Mvc_Micro, setService) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&container, "set", NULL, 388, &serviceName, definition, &_0);
	zephir_check_call_status();
	RETURN_MM();
