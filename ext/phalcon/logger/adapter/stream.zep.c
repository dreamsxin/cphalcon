...
PHP_METHOD(Phalcon_Logger_Adapter_Stream, process) {
	...
	if (!(Z_TYPE_P(&_0) == IS_RESOURCE)) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$3, "fopen", NULL, 77, &_1$$3, &_2$$3);
		...
		if (!(Z_TYPE_P(&_4$$3) == IS_RESOURCE)) {
			...
			ZEPHIR_CALL_FUNCTION(&_9$$4, "sprintf", NULL, 170, &_8$$4, &_6$$4, &_7$$4);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 333, &_9$$4);
			zephir_check_call_status();
