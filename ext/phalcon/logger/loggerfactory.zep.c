...
PHP_METHOD(Phalcon_Logger_LoggerFactory, load) {
	...
	if (Z_TYPE_P(&adapters) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&adapters), _6)
		{
			...
			ZEPHIR_CALL_CE_STATIC(&adapterClass, phalcon_helper_arr_ce, "get", &_2, 5, &adapter, &_8$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_8$$6);
			ZVAL_STRING(&_8$$6, "name");
			ZEPHIR_CALL_CE_STATIC(&adapterFileName, phalcon_helper_arr_ce, "get", &_2, 5, &adapter, &_8$$6);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_8$$6);
			array_init(&_8$$6);
			ZEPHIR_INIT_NVAR(&_9$$6);
			ZVAL_STRING(&_9$$6, "options");
			ZEPHIR_CALL_CE_STATIC(&adapterOptions, phalcon_helper_arr_ce, "get", &_2, 5, &adapter, &_9$$6, &_8$$6);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_CE_STATIC(&adapterClass, phalcon_helper_arr_ce, "get", &_2, 5, &adapter, &_12$$7);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_12$$7);
				ZVAL_STRING(&_12$$7, "name");
				ZEPHIR_CALL_CE_STATIC(&adapterFileName, phalcon_helper_arr_ce, "get", &_2, 5, &adapter, &_12$$7);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_12$$7);
				array_init(&_12$$7);
				ZEPHIR_INIT_NVAR(&_13$$7);
				ZVAL_STRING(&_13$$7, "options");
				ZEPHIR_CALL_CE_STATIC(&adapterOptions, phalcon_helper_arr_ce, "get", &_2, 5, &adapter, &_13$$7, &_12$$7);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Logger_LoggerFactory, newInstance) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 375, &name, &adapters);
	zephir_check_call_status();
	RETURN_MM();
