...
PHP_METHOD(Phalcon_Db_Dialect, select) {
	...
	if (_5) {
		...
		ZEPHIR_CALL_METHOD(&_6$$9, this_ptr, "getsqlexpressionjoins", NULL, 59, &_7$$9, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_9) {
		ZEPHIR_CALL_METHOD(&_10$$10, this_ptr, "getsqlexpressionwhere", NULL, 60, &where, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_12) {
		ZEPHIR_CALL_METHOD(&_13$$11, this_ptr, "getsqlexpressiongroupby", NULL, 61, &groupBy, &escapeChar);
		zephir_check_call_status();
	...
	if (_15) {
		ZEPHIR_CALL_METHOD(&_16$$12, this_ptr, "getsqlexpressionhaving", NULL, 62, &having, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_18) {
		ZEPHIR_CALL_METHOD(&_19$$13, this_ptr, "getsqlexpressionorderby", NULL, 63, &orderBy, &escapeChar, &bindCounts);
		zephir_check_call_status();
	...
	if (_21) {
		...
		ZEPHIR_CALL_METHOD(&sql, this_ptr, "getsqlexpressionlimit", NULL, 64, &_22$$14, &escapeChar, &bindCounts);
		zephir_check_call_status();
	}
