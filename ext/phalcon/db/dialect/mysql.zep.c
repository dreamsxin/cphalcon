...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, addColumn) {
	...
	if (zephir_is_true(&_4)) {
		...
		if (zephir_memnstr_str(&_5$$3, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 43)) {
			...
			ZVAL_STRING(&_6$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_7$$5, "addcslashes", NULL, 178, &defaultValue, &_6$$5);
			zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _2)
		{
			...
			if (zephir_is_true(&_7$$7)) {
				...
				if (zephir_memnstr_str(&_8$$8, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 174)) {
					...
					ZVAL_STRING(&_9$$10, "\"");
					ZEPHIR_CALL_FUNCTION(&_10$$10, "addcslashes", &_11, 178, &defaultValue, &_9$$10);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_18$$14)) {
					...
					if (zephir_memnstr_str(&_19$$15, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 174)) {
						...
						ZVAL_STRING(&_20$$17, "\"");
						ZEPHIR_CALL_FUNCTION(&_21$$17, "addcslashes", &_11, 178, &defaultValue, &_20$$17);
						zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _26$$21)
			{
				...
				if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_28$$23, this_ptr, "getcolumnlist", &_30, 57, &_29$$23);
					zephir_check_call_status();
					...
					if (!(ZEPHIR_IS_EMPTY(&indexType))) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_32$$25, this_ptr, "getcolumnlist", &_30, 57, &_33$$25);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_35$$26, this_ptr, "getcolumnlist", &_30, 57, &_36$$26);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_38$$28, this_ptr, "getcolumnlist", &_30, 57, &_39$$28);
						zephir_check_call_status();
						...
						if (!(ZEPHIR_IS_EMPTY(&indexType))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_41$$30, this_ptr, "getcolumnlist", &_30, 57, &_42$$30);
							zephir_check_call_status();
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_44$$31, this_ptr, "getcolumnlist", &_30, 57, &_45$$31);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _47$$32)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_50$$33, this_ptr, "getcolumnlist", &_30, 57, &_51$$33);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_53$$33, this_ptr, "getcolumnlist", &_30, 57, &_54$$33);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_59$$36, this_ptr, "getcolumnlist", &_30, 57, &_60$$36);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_62$$36, this_ptr, "getcolumnlist", &_30, 57, &_63$$36);
					zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, getColumnDefinition) {
	...
	do {
		if (ZEPHIR_IS_LONG(&columnType, 14)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_1$$3, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
			ZEPHIR_INIT_VAR(&_2$$3);
		...
		if (ZEPHIR_IS_LONG(&columnType, 3)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_6$$17, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 9)) {
			...
			ZEPHIR_CALL_METHOD(&_8$$19, this_ptr, "checkcolumnsizeandscale", NULL, 180, column);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_9$$19, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 7)) {
			...
			ZEPHIR_CALL_METHOD(&_12$$23, this_ptr, "checkcolumnsizeandscale", NULL, 180, column);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_13$$23, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 0)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_16$$25, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 21)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_19$$35, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 22)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_22$$39, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
		...
		if (ZEPHIR_IS_LONG(&columnType, 26)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(&_25$$49, this_ptr, "checkcolumnunsigned", NULL, 179, column);
			zephir_check_call_status();
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _31$$58)
					{
						...
						ZVAL_STRING(&_33$$59, "\"");
						ZEPHIR_CALL_FUNCTION(&_34$$59, "addcslashes", &_35, 178, &value$$58, &_33$$59);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_37$$60, "\"");
							ZEPHIR_CALL_FUNCTION(&_38$$60, "addcslashes", &_35, 178, &value$$58, &_37$$60);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_44$$61, "\"");
				ZEPHIR_CALL_FUNCTION(&_45$$61, "addcslashes", &_35, 178, &typeValues, &_44$$61);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Mysql, modifyColumn) {
	...
	if (zephir_is_true(&_9)) {
		...
		if (zephir_memnstr_str(&_10$$6, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Mysql.zep", 689)) {
			...
			ZVAL_STRING(&_11$$8, "\"");
			ZEPHIR_CALL_FUNCTION(&_12$$8, "addcslashes", NULL, 178, &defaultValue, &_11$$8);
			zephir_check_call_status();
