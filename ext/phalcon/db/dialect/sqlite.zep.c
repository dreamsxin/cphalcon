...
PHP_METHOD(Phalcon_Db_Dialect_Sqlite, addColumn) {
	...
	if (zephir_is_true(&_5)) {
		...
		if (zephir_memnstr_str(&_6$$3, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 45)) {
			...
			ZVAL_STRING(&_7$$5, "\"");
			ZEPHIR_CALL_FUNCTION(&_8$$5, "addcslashes", NULL, 178, &defaultValue, &_7$$5);
			zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&columns), _2)
		{
			...
			if (zephir_is_true(&_11$$7)) {
				...
				if (zephir_memnstr_str(&_12$$10, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 172)) {
					...
					ZVAL_STRING(&_13$$12, "\"");
					ZEPHIR_CALL_FUNCTION(&_14$$12, "addcslashes", &_15, 178, &defaultValue, &_13$$12);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&_24$$14)) {
					...
					if (zephir_memnstr_str(&_25$$17, SL("CURRENT_TIMESTAMP"), "phalcon/Db/Dialect/Sqlite.zep", 172)) {
						...
						ZVAL_STRING(&_26$$19, "\"");
						ZEPHIR_CALL_FUNCTION(&_27$$19, "addcslashes", &_15, 178, &defaultValue, &_26$$19);
						zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _30$$21)
			{
				...
				if (_32$$22) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_35$$23, this_ptr, "getcolumnlist", &_37, 57, &_36$$23);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_39$$24, this_ptr, "getcolumnlist", &_37, 57, &_40$$24);
					zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (_42$$25) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_45$$26, this_ptr, "getcolumnlist", &_37, 57, &_46$$26);
						zephir_check_call_status();
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_48$$27, this_ptr, "getcolumnlist", &_37, 57, &_49$$27);
						zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _51$$28)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_54$$29, this_ptr, "getcolumnlist", &_37, 57, &_55$$29);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_57$$29, this_ptr, "getcolumnlist", &_37, 57, &_58$$29);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_62$$32, this_ptr, "getcolumnlist", &_37, 57, &_63$$32);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_65$$32, this_ptr, "getcolumnlist", &_37, 57, &_66$$32);
					zephir_check_call_status();
					ZEPHIR_INIT_NVAR(&referenceSql);
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _8$$40)
					{
						...
						ZVAL_STRING(&_10$$41, "\"");
						ZEPHIR_CALL_FUNCTION(&_11$$41, "addcslashes", &_12, 178, &value$$40, &_10$$41);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_14$$42, "\"");
							ZEPHIR_CALL_FUNCTION(&_15$$42, "addcslashes", &_12, 178, &value$$40, &_14$$42);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_21$$43, "\"");
				ZEPHIR_CALL_FUNCTION(&_22$$43, "addcslashes", &_12, 178, &typeValues, &_21$$43);
				zephir_check_call_status();
