...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, createTable) {
	...
	if (!(ZEPHIR_IS_EMPTY(&primaryColumns))) {
		ZEPHIR_CALL_METHOD(&_22$$15, this_ptr, "getcolumnlist", NULL, 57, &primaryColumns);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&indexes) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&indexes), _24$$16)
			{
				...
				if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_26$$18, this_ptr, "getcolumnlist", NULL, 57, &_27$$18);
					zephir_check_call_status();
					...
					if (!(ZEPHIR_IS_EMPTY(&indexType))) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_29$$20, this_ptr, "getcolumnlist", NULL, 57, &_30$$20);
						zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					if (ZEPHIR_IS_STRING(&indexName, "PRIMARY")) {
						...
						zephir_check_call_status();
						ZEPHIR_CALL_METHOD(&_38$$24, this_ptr, "getcolumnlist", NULL, 57, &_39$$24);
						zephir_check_call_status();
						...
						if (!(ZEPHIR_IS_EMPTY(&indexType))) {
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_41$$26, this_ptr, "getcolumnlist", NULL, 57, &_42$$26);
							zephir_check_call_status();
							...
							zephir_check_call_status();
							ZEPHIR_CALL_METHOD(&_47$$27, this_ptr, "getcolumnlist", NULL, 57, &_48$$27);
							zephir_check_call_status();
	...
	if (zephir_array_isset_string_fetch(&references, &definition, SL("references"), 0)) {
		...
		if (Z_TYPE_P(&references) == IS_ARRAY) {
			ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&references), _50$$29)
			{
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_53$$30, this_ptr, "getcolumnlist", NULL, 57, &_54$$30);
				zephir_check_call_status();
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(&_58$$30, this_ptr, "getcolumnlist", NULL, 57, &_59$$30);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_64$$33, this_ptr, "getcolumnlist", NULL, 57, &_65$$33);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_METHOD(&_69$$33, this_ptr, "getcolumnlist", NULL, 57, &_70$$33);
					zephir_check_call_status();
			...
			if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
				...
				if (Z_TYPE_P(&typeValues) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&typeValues), _8$$36)
					{
						...
						ZVAL_STRING(&_10$$37, "\\'");
						ZEPHIR_CALL_FUNCTION(&_11$$37, "addcslashes", &_12, 178, &value$$36, &_10$$37);
						zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							ZVAL_STRING(&_14$$38, "\\'");
							ZEPHIR_CALL_FUNCTION(&_15$$38, "addcslashes", &_12, 178, &value$$36, &_14$$38);
							zephir_check_call_status();
				...
				ZVAL_STRING(&_21$$39, "\\'");
				ZEPHIR_CALL_FUNCTION(&_22$$39, "addcslashes", &_12, 178, &typeValues, &_21$$39);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Dialect_Postgresql, castDefault) {
	...
	if (_5) {
		...
		ZVAL_STRING(&_7$$6, "\\'");
		ZEPHIR_CALL_FUNCTION(&_8$$6, "addcslashes", NULL, 178, &defaultValue, &_7$$6);
		zephir_check_call_status();
