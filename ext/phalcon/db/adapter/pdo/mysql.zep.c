...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeColumns) {
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_54$$3, "__construct", &_55, 177, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_106$$43, "__construct", &_55, 177, &columnName, &definition);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeIndexes) {
	...
	if (Z_TYPE_P(&indexes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _24, _25, _22)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_26$$19, "__construct", &_29, 22, &name, &_27$$19, &_28$$19);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_30$$20, "__construct", &_29, 22, &name, &_31$$20, &_32$$20);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Mysql, describeReferences) {
	...
	if (Z_TYPE_P(&references) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _26, _27, _24)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_28$$9, "__construct", &_31, 23, &name, &_29$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_32$$10, "__construct", &_31, 23, &name, &_33$$10);
				zephir_check_call_status();
