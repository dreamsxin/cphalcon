...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeColumns) {
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			ZEPHIR_CALL_FUNCTION(&_32$$3, "strcasecmp", &_33, 38, &_30$$3, &_31$$3);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_METHOD(NULL, &_31$$3, "__construct", &_41, 177, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_FUNCTION(&_70$$28, "strcasecmp", &_33, 38, &_68$$28, &_69$$28);
				zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_69$$28, "__construct", &_41, 177, &columnName, &definition);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeIndexes) {
	...
	if (Z_TYPE_P(&indexes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _45, _46, _43)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_47$$23, "__construct", &_50, 22, &name, &_48$$23, &_49$$23);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_51$$24, "__construct", &_50, 22, &name, &_52$$24, &_53$$24);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Sqlite, describeReferences) {
	...
	if (Z_TYPE_P(&references) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _24, _25, _22)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_26$$9, "__construct", &_29, 23, &name, &_27$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_30$$10, "__construct", &_29, 23, &name, &_31$$10);
				zephir_check_call_status();
