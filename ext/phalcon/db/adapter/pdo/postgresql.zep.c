...
PHP_METHOD(Phalcon_Db_Adapter_Pdo_Postgresql, describeColumns) {
	...
	if (Z_TYPE_P(&fields) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&fields), _3)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_59$$3, "__construct", &_60, 177, &columnName, &definition);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&_107$$40) != IS_NULL) {
					...
					ZVAL_STRING(&_110$$75, "");
					ZEPHIR_CALL_FUNCTION(&_111$$75, "preg_replace", &_55, 40, &_109$$75, &_110$$75, &_108$$75);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_113$$75, "strcasecmp", &_58, 38, &_112$$75, &_109$$75);
					zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_114$$40, "__construct", &_60, 177, &columnName, &definition);
				zephir_check_call_status();
