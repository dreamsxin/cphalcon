...
PHP_METHOD(Phalcon_Db_Adapter, describeIndexes) {
	...
	if (Z_TYPE_P(&indexes) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&indexes), _10, _11, _8)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_12$$9, "__construct", &_13, 22, &name, &indexColumns);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_14$$10, "__construct", &_13, 22, &name, &indexColumns);
				zephir_check_call_status();
...
PHP_METHOD(Phalcon_Db_Adapter, describeReferences) {
	...
	if (Z_TYPE_P(&references) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&references), _22, _23, _20)
		{
			...
			ZEPHIR_CALL_METHOD(NULL, &_24$$9, "__construct", &_27, 23, &name, &_25$$9);
			zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				ZEPHIR_CALL_METHOD(NULL, &_28$$10, "__construct", &_27, 23, &name, &_29$$10);
				zephir_check_call_status();
