...
PHP_METHOD(Phalcon_Tag, checkField) {
	...
	ZEPHIR_RETURN_CALL_SELF("inputfieldchecked", &_0, 495, &_1, parameters);
...
PHP_METHOD(Phalcon_Tag, colorField) {
	...
	ZEPHIR_RETURN_CALL_SELF("inputfield", &_0, 496, &_1, parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, friendlyTitle) {
	...
	ZEPHIR_INIT_VAR(&_15);
	ZVAL_STRING(&_15, "");
	ZEPHIR_CALL_FUNCTION(&friendly, "preg_replace", NULL, 40, &_0, &_15, &text);
	zephir_check_call_status();
	if (lowercase) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "/[\\/_|+ -]+/");
	ZEPHIR_CALL_FUNCTION(&_17, "preg_replace", NULL, 40, &_0, &separator, &friendly);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "iconv");
	ZEPHIR_CALL_FUNCTION(&_17, "extension_loaded", NULL, 156, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_17)) {
		ZVAL_LONG(&_18$$11, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 265, &_18$$11, &locale);
		zephir_check_call_status();
	}
...
PHP_METHOD(Phalcon_Tag, getTitle) {
	...
	if (prepend) {
		...
		if (!(ZEPHIR_IS_EMPTY(&documentPrependTitle))) {
			ZEPHIR_CALL_FUNCTION(&tmp$$5, "array_reverse", NULL, 268, &documentPrependTitle);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Tag, imageInput) {
	...
	ZVAL_BOOL(&_2, 1);
	ZEPHIR_RETURN_CALL_SELF("inputfield", &_0, 496, &_1, parameters, &_2);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Tag, textArea) {
	...
	ZEPHIR_CALL_SELF(&code, "renderattributes", NULL, 0, &_1, &params);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_2, "htmlspecialchars", NULL, 210, &content);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_3);
