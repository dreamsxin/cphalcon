...
PHP_METHOD(Phalcon_Di, __call) {
	...
	if (zephir_start_with_str(&method, SL("get"))) {
		...
		ZEPHIR_CALL_FUNCTION(&possibleService, "lcfirst", NULL, 84, &_1$$3);
	...
	if (zephir_start_with_str(&method, SL("set"))) {
		...
		if (zephir_array_isset_long_fetch(&definition, &arguments, 0, 0 TSRMLS_CC)) {
			...
			ZEPHIR_CALL_FUNCTION(&_5$$6, "lcfirst", NULL, 84, &_4$$6);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di, attempt) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_1, "__construct", NULL, 85, definition, &_2);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di, loadFromPhp) {
	...
	ZEPHIR_CALL_METHOD(NULL, &services, "__construct", NULL, 86, &filePath);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Di, loadFromYaml) {
	...
	ZEPHIR_CALL_METHOD(NULL, &services, "__construct", NULL, 87, &filePath, &callbacks);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, this_ptr, "loadfromconfig", NULL, 0, &services);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Phalcon_Di, set) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 85, definition, &_1);
	zephir_check_call_status();
