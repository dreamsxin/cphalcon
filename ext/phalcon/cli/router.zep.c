...
PHP_METHOD(Phalcon_Cli_Router, __construct) {
	...
	if (defaultRoutes) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 150, &_2$$3, &_1$$3);
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 150, &_4$$3, &_3$$3);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Cli_Router, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 150, &pattern, paths);
	zephir_check_call_status();
