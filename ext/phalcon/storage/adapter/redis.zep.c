...
PHP_METHOD(Phalcon_Storage_Adapter_Redis, getAdapter) {
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "setserializer", NULL, 105, &connection);
		zephir_check_call_status();
