...
PHP_METHOD(Phalcon_Validation_Validator_Ip, validate) {
	...
	ZVAL_LONG(&_4, 275);
	ZEPHIR_CALL_FUNCTION(&_15, "filter_var", NULL, 221, &value, &_4, &options);
	zephir_check_call_status();
	if (!(zephir_is_true(&_15))) {
		...
		ZEPHIR_CALL_FUNCTION(&_17$$12, "strtr", NULL, 82, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_18$$12);
		ZVAL_STRING(&_18$$12, "Ip");
		ZEPHIR_CALL_METHOD(NULL, &_16$$12, "__construct", NULL, 376, &_17$$12, field, &_18$$12);
		zephir_check_call_status();
