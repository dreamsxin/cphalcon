...
PHP_METHOD(Phalcon_Validation_Validator_File, validate) {
	...
	if (_5) {
		...
		ZEPHIR_CALL_FUNCTION(&_10$$3, "strtr", NULL, 82, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_9$$3);
		ZVAL_STRING(&_9$$3, "FileIniSize");
		ZEPHIR_CALL_METHOD(NULL, &_8$$3, "__construct", NULL, 376, &_10$$3, field, &_9$$3, &code);
		zephir_check_call_status();
	...
	if (!(_14)) {
		...
		ZEPHIR_CALL_FUNCTION(&_16, "is_uploaded_file", NULL, 346, &_15);
		zephir_check_call_status();
	...
	if (_14) {
		...
		ZEPHIR_CALL_FUNCTION(&_20$$4, "strtr", NULL, 82, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_18$$4);
		ZVAL_STRING(&_18$$4, "FileEmpty");
		ZEPHIR_CALL_METHOD(NULL, &_17$$4, "__construct", NULL, 376, &_20$$4, field, &_18$$4, &code);
		zephir_check_call_status();
	...
	if (_22) {
		...
		ZEPHIR_CALL_FUNCTION(&_26$$5, "strtr", NULL, 82, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_24$$5);
		ZVAL_STRING(&_24$$5, "FileValid");
		ZEPHIR_CALL_METHOD(NULL, &_23$$5, "__construct", NULL, 376, &_26$$5, field, &_24$$5, &code);
		zephir_check_call_status();
	...
	if (zephir_is_true(&_27)) {
		...
		ZEPHIR_CALL_FUNCTION(&_35$$6, "floatval", NULL, 404, &_34$$6);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_35$$6, "floatval", NULL, 404, &_39$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&_40$$6, "floatval", NULL, 404, &bytes);
		zephir_check_call_status();
		if (ZEPHIR_GT(&_35$$6, &_40$$6)) {
			...
			ZEPHIR_CALL_FUNCTION(&_44$$9, "strtr", NULL, 82, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_42$$9);
			ZVAL_STRING(&_42$$9, "FileSize");
			ZEPHIR_CALL_METHOD(NULL, &_41$$9, "__construct", NULL, 376, &_44$$9, field, &_42$$9, &code);
			zephir_check_call_status();
	...
	if (zephir_is_true(&_45)) {
		...
		if ((zephir_function_exists_ex(SL("finfo_open") TSRMLS_CC) == SUCCESS)) {
			ZVAL_LONG(&_47$$13, 16);
			ZEPHIR_CALL_FUNCTION(&tmp, "finfo_open", NULL, 343, &_47$$13);
			zephir_check_call_status();
			...
			ZEPHIR_CALL_FUNCTION(&mime, "finfo_file", NULL, 344, &tmp, &_48$$13);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(NULL, "finfo_close", NULL, 345, &tmp);
			zephir_check_call_status();
		} else {
		...
		if (!(zephir_fast_in_array(&mime, &types TSRMLS_CC))) {
			...
			ZEPHIR_CALL_FUNCTION(&_52$$15, "strtr", NULL, 82, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_50$$15);
			ZVAL_STRING(&_50$$15, "FileType");
			ZEPHIR_CALL_METHOD(NULL, &_49$$15, "__construct", NULL, 376, &_52$$15, field, &_50$$15, &code);
			zephir_check_call_status();
	...
	if (_54) {
		...
		ZEPHIR_CALL_FUNCTION(&tmp, "getimagesize", NULL, 351, &_56$$16);
		zephir_check_call_status();
		...
		if (_61$$16) {
			...
			ZEPHIR_CALL_FUNCTION(&_65$$20, "strtr", NULL, 82, &message, &replacePairs);
			zephir_check_call_status();
			ZEPHIR_INIT_NVAR(&_63$$20);
			ZVAL_STRING(&_63$$20, "FileMinResolution");
			ZEPHIR_CALL_METHOD(NULL, &_62$$20, "__construct", NULL, 376, &_65$$20, field, &_63$$20, &code);
			zephir_check_call_status();
		...
		if (zephir_is_true(&_66$$16)) {
			...
			if (_69$$21) {
				...
				ZEPHIR_CALL_FUNCTION(&_73$$23, "strtr", NULL, 82, &message, &replacePairs);
				zephir_check_call_status();
				ZEPHIR_INIT_NVAR(&_71$$23);
				ZVAL_STRING(&_71$$23, "FileMaxResolution");
				ZEPHIR_CALL_METHOD(NULL, &_70$$23, "__construct", NULL, 376, &_73$$23, field, &_71$$23, &code);
				zephir_check_call_status();
