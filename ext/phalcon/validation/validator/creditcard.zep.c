...
PHP_METHOD(Phalcon_Validation_Validator_CreditCard, validate) {
	...
	if (!(zephir_is_true(&valid))) {
		...
		ZEPHIR_CALL_FUNCTION(&_1$$3, "strtr", NULL, 82, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "CreditCard");
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 376, &_1$$3, field, &_2$$3, &code);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Validation_Validator_CreditCard, verifyByLuhnAlgorithm) {
	...
	ZVAL_STRING(&hash, "");
	ZEPHIR_CALL_FUNCTION(&_0, "str_split", NULL, 96, &number);
	zephir_check_call_status();
	zephir_get_arrval(&_1, &_0);
	ZEPHIR_CPY_WRT(&digits, &_1);
	ZEPHIR_CALL_FUNCTION(&_3, "array_reverse", NULL, 268, &digits);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&digit);
	ZEPHIR_INIT_NVAR(&position);
	ZEPHIR_CALL_FUNCTION(&_10, "str_split", NULL, 96, &hash);
	zephir_check_call_status();
