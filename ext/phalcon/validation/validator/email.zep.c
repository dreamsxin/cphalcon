...
PHP_METHOD(Phalcon_Validation_Validator_Email, validate) {
	...
	ZVAL_LONG(&_0, 274);
	ZEPHIR_CALL_FUNCTION(&_1, "filter_var", NULL, 221, &value, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(&_1))) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$3, "strtr", NULL, 82, &message, &replacePairs);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "Email");
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 376, &_3$$3, field, &_4$$3, &code);
		zephir_check_call_status();
