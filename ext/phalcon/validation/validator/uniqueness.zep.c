...
PHP_METHOD(Phalcon_Validation_Validator_Uniqueness, validate) {
	...
	if (!(zephir_is_true(&_0))) {
		...
		ZEPHIR_CALL_FUNCTION(&_4$$3, "strtr", NULL, 82, &message, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 376, &_4$$3, field, &_6$$3, &_5$$3);
		zephir_check_call_status();
		...
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&field), _1)
		{
			...
			if (zephir_is_true(&except)) {
				...
				if (_9$$6) {
					...
					ZEPHIR_CALL_FUNCTION(&_13$$6, "range", &_14, 260, &_11$$6, &_12$$6);
					zephir_check_call_status();
			...
			zephir_check_call_status();
				...
				if (zephir_is_true(&except)) {
					...
					if (_87$$37) {
						...
						ZEPHIR_CALL_FUNCTION(&_91$$37, "range", &_14, 260, &_89$$37, &_90$$37);
						zephir_check_call_status();
