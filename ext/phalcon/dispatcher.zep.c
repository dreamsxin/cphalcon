...
PHP_METHOD(Phalcon_Dispatcher, dispatch) {
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&handlerHash, "spl_object_hash", &_37, 88, &handler);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Dispatcher, getActiveMethod) {
	...
	if (!(zephir_array_isset_fetch(&activeMethodName, &_0, &_1, 0 TSRMLS_CC))) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&activeMethodName, "lcfirst", NULL, 84, &_2$$3);
		zephir_check_call_status();
		ZEPHIR_OBS_VAR(&_4$$3);
...
PHP_METHOD(Phalcon_Dispatcher, toCamelCase) {
	...
	if (!(zephir_array_isset_fetch(&camelCaseInput, &_0, &input, 0 TSRMLS_CC))) {
		...
		ZVAL_STRING(&_1$$3, "/[_-]+/");
		ZEPHIR_CALL_FUNCTION(&_2$$3, "preg_split", NULL, 89, &_1$$3, &input);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_1$$3);
		ZVAL_STRING(&_1$$3, "ucfirst");
		ZEPHIR_CALL_FUNCTION(&_3$$3, "array_map", NULL, 90, &_1$$3, &_2$$3);
		zephir_check_call_status();
