...
PHP_METHOD(Phalcon_Image_Adapter_Gd, __construct) {
	...
	if ((zephir_file_exists(&_1 TSRMLS_CC) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&imageinfo, "getimagesize", NULL, 351, &_4$$4);
		zephir_check_call_status();
		...
		if (UNEXPECTED(_26$$13)) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_27$$14, "__construct", NULL, 1, &_29$$14);
			zephir_check_call_status();
			zephir_throw_exception_debug(&_27$$14, "phalcon/Image/Adapter/Gd.zep", 80 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 352, &_30$$13, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processFlip) {
	...
	if (direction == 11) {
		...
		ZEPHIR_GET_CONSTANT(&_1$$3, "IMG_FLIP_HORIZONTAL");
		...
		ZEPHIR_GET_CONSTANT(&_3$$4, "IMG_FLIP_VERTICAL");
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processMask) {
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_21$$5, x);
			ZVAL_LONG(&_22$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_23, 356, &maskImage, &_21$$5, &_22$$5);
			zephir_check_call_status();
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_24, 357, &maskImage, &index);
			zephir_check_call_status();
			...
			ZVAL_LONG(&_22$$5, x);
			ZVAL_LONG(&_27$$5, y);
			ZEPHIR_CALL_FUNCTION(&index, "imagecolorat", &_23, 356, &_21$$5, &_22$$5, &_27$$5);
			zephir_check_call_status();
			zephir_read_property(&_22$$5, this_ptr, SL("image"), PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorsforindex", &_24, 357, &_22$$5, &index);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(&r);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processPixelate) {
	...
	while (1) {
		...
		while (1) {
			...
			ZVAL_LONG(&_6$$4, x1);
			ZVAL_LONG(&_7$$4, y1);
			ZEPHIR_CALL_FUNCTION(&color, "imagecolorat", &_8, 356, &_5$$4, &_6$$4, &_7$$4);
			zephir_check_call_status();
			x2 = (x + amount);
			y2 = (y + amount);
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processReflection) {
	...
	zend_bool fadeIn;
	zval *height_param = NULL, *opacity_param = NULL, *fadeIn_param = NULL, reflection, line, _0, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _27, _28, _11$$5, _12$$5, _17$$5, _18$$5, _19$$5, _20$$5, _21$$5, _22$$5, _23$$5, _24$$5, _25$$5, _26$$5, _13$$6, _14$$6, _15$$7, _16$$7;
	...
	ZEPHIR_CALL_FUNCTION(&_2, "abs", NULL, 222, &_1);
	zephir_check_call_status();
	...
	while (1) {
		...
		ZEPHIR_GET_CONSTANT(&_25$$5, "IMG_FILTER_COLORIZE");
		ZVAL_LONG(&_20$$5, 0);
		ZVAL_LONG(&_21$$5, 0);
		ZVAL_LONG(&_22$$5, 0);
		ZVAL_LONG(&_23$$5, dst_opacity);
		ZEPHIR_CALL_FUNCTION(NULL, "imagefilter", NULL, 0, &line, &_25$$5, &_20$$5, &_21$$5, &_22$$5, &_23$$5);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRender) {
	...
	ZEPHIR_CALL_FUNCTION(NULL, "ob_start", NULL, 358);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "gif");
	ZEPHIR_CALL_FUNCTION(&_2, "strcmp", NULL, 359, &ext, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "jpg");
	ZEPHIR_CALL_FUNCTION(&_3, "strcmp", NULL, 359, &ext, &_1);
	zephir_check_call_status();
	_4 = ZEPHIR_IS_LONG(&_3, 0);
	if (!(_4)) {
		ZEPHIR_INIT_NVAR(&_1);
		ZVAL_STRING(&_1, "jpeg");
		ZEPHIR_CALL_FUNCTION(&_5, "strcmp", NULL, 359, &ext, &_1);
		zephir_check_call_status();
		_4 = ZEPHIR_IS_LONG(&_5, 0);
	}
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "png");
	ZEPHIR_CALL_FUNCTION(&_6, "strcmp", NULL, 359, &ext, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "wbmp");
	ZEPHIR_CALL_FUNCTION(&_7, "strcmp", NULL, 359, &ext, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "xbm");
	ZEPHIR_CALL_FUNCTION(&_8, "strcmp", NULL, 359, &ext, &_1);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&_2, 0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_17$$8, "__construct", NULL, 1, &_18$$8);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_17$$8, "phalcon/Image/Adapter/Gd.zep", 451 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_RETURN_CALL_FUNCTION("ob_get_clean", NULL, 360);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processSave) {
	...
	ZVAL_LONG(&_0, 4);
	ZEPHIR_CALL_FUNCTION(&ext, "pathinfo", NULL, 97, &file, &_0);
	zephir_check_call_status();
	if (!(zephir_is_true(&ext))) {
		zephir_read_property(&_1$$3, this_ptr, SL("type"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&ext, "image_type_to_extension", NULL, 361, &_1$$3, &__$false);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(&_2);
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "gif");
	ZEPHIR_CALL_FUNCTION(&_3, "strcmp", NULL, 359, &ext, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&_3, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_5$$4, "image_type_to_mime_type", NULL, 362, &_4$$4);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "jpg");
	ZEPHIR_CALL_FUNCTION(&_7, "strcmp", NULL, 359, &ext, &_2);
	zephir_check_call_status();
	_8 = ZEPHIR_IS_LONG(&_7, 0);
	if (!(_8)) {
		ZEPHIR_INIT_NVAR(&_2);
		ZVAL_STRING(&_2, "jpeg");
		ZEPHIR_CALL_FUNCTION(&_9, "strcmp", NULL, 359, &ext, &_2);
		zephir_check_call_status();
	...
	if (_8) {
		...
		ZEPHIR_CALL_FUNCTION(&_11$$5, "image_type_to_mime_type", NULL, 362, &_10$$5);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "png");
	ZEPHIR_CALL_FUNCTION(&_15, "strcmp", NULL, 359, &ext, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&_15, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_17$$10, "image_type_to_mime_type", NULL, 362, &_16$$10);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "wbmp");
	ZEPHIR_CALL_FUNCTION(&_19, "strcmp", NULL, 359, &ext, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&_19, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_21$$11, "image_type_to_mime_type", NULL, 362, &_20$$11);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "xbm");
	ZEPHIR_CALL_FUNCTION(&_23, "strcmp", NULL, 359, &ext, &_2);
	zephir_check_call_status();
	if (ZEPHIR_IS_LONG(&_23, 0)) {
		...
		ZEPHIR_CALL_FUNCTION(&_25$$12, "image_type_to_mime_type", NULL, 362, &_24$$12);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processText) {
	...
	if (!(Z_TYPE_P(&fontfile) == IS_UNDEF) && Z_STRLEN_P(&fontfile)) {
		ZVAL_LONG(&_3$$3, size);
		ZVAL_LONG(&_4$$3, 0);
		ZEPHIR_CALL_FUNCTION(&space, "imagettfbbox", NULL, 363, &_3$$3, &_4$$3, &fontfile, &text);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_12$$3, "abs", NULL, 222, &_3$$3);
		zephir_check_call_status();
		width = (zephir_get_numberval(&_12$$3) + 10);
		ZVAL_LONG(&_3$$3, (s5 - s1));
		ZEPHIR_CALL_FUNCTION(&_13$$3, "abs", NULL, 222, &_3$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagettftext", NULL, 364, &_4$$3, &_16$$3, &_17$$3, &_18$$3, &_19$$3, &color, &fontfile, &text);
		zephir_check_call_status();
	} else {
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processWatermark) {
	...
	if (opacity < 100) {
		...
		ZEPHIR_CALL_FUNCTION(&_6$$3, "abs", NULL, 222, &_5$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&color, "imagecolorallocatealpha", NULL, 355, &overlay, &_5$$3, &_7$$3, &_8$$3, &_9$$3);
		zephir_check_call_status();
	...
	zephir_read_property(&_1, this_ptr, SL("image"), PH_NOISY_CC | PH_READONLY);
	ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 352, &_1, &__$true);
	zephir_check_call_status();
