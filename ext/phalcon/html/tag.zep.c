...
PHP_METHOD(Phalcon_Html_Tag, button) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "renderinput", NULL, 262, &_0, &name, &parameters);
...
PHP_METHOD(Phalcon_Html_Tag, element) {
	...
	ZEPHIR_CALL_METHOD(&output, this_ptr, "renderattributes", NULL, 263, &_3, &parameters);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, form) {
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "url");
	ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 264, &_0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<form");
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "renderattributes", NULL, 263, &_0, &parameters);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, friendlyTitle) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "extension_loaded", NULL, 156, &_0);
	zephir_check_call_status();
	if (zephir_is_true(&_1)) {
		ZVAL_LONG(&_2$$3, 6);
		ZEPHIR_INIT_VAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "en_US.UTF-8");
		ZEPHIR_CALL_FUNCTION(&locale, "setlocale", NULL, 265, &_2$$3, &_3$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_3$$3);
		ZVAL_STRING(&_3$$3, "UTF-8");
		ZEPHIR_INIT_VAR(&_4$$3);
		ZVAL_STRING(&_4$$3, "ASCII//TRANSLIT");
		ZEPHIR_CALL_FUNCTION(&_5$$3, "iconv", NULL, 266, &_3$$3, &_4$$3, &text);
		zephir_check_call_status();
	...
	if (!(ZEPHIR_IS_EMPTY(&replace))) {
		...
		ZVAL_STRING(&_13$$4, " ");
		ZEPHIR_CALL_FUNCTION(&to, "array_fill", NULL, 267, &_11$$4, &_12$$4, &_13$$4);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_9);
	ZVAL_STRING(&_9, "");
	ZEPHIR_CALL_FUNCTION(&output, "preg_replace", NULL, 40, &_8, &_9, &text);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_8);
	ZVAL_STRING(&_8, "/[\\/_|+ -]+/");
	ZEPHIR_CALL_FUNCTION(&_15, "preg_replace", NULL, 40, &_8, &separator, &output);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_15, "extension_loaded", NULL, 156, &_8);
	zephir_check_call_status();
	if (zephir_is_true(&_15)) {
		ZVAL_LONG(&_16$$9, 6);
		ZEPHIR_CALL_FUNCTION(NULL, "setlocale", NULL, 265, &_16$$9, &locale);
		zephir_check_call_status();
	}
	RETURN_CCTOR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, getTitle) {
	...
	ZEPHIR_CALL_METHOD(&escaper, this_ptr, "getservice", NULL, 264, &_0);
	zephir_check_call_status();
	...
	if (prepend) {
		...
		if (!(ZEPHIR_IS_EMPTY(&prependTitle))) {
			ZEPHIR_CALL_FUNCTION(&prependArray$$4, "array_reverse", NULL, 268, &prependTitle);
			zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, image) {
	...
	if (zephir_is_true(&local)) {
		...
		ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 264, &_3$$3);
		zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "<img");
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderattributes", NULL, 263, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderclosetag", NULL, 269);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, inputCheckbox) {
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "renderinputchecked", NULL, 270, &_0, &name, &parameters);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Phalcon_Html_Tag, javascript) {
	...
	if (local) {
		...
		ZEPHIR_CALL_METHOD(&service, this_ptr, "getservice", NULL, 264, &_4$$3);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_10, this_ptr, "renderattributes", NULL, 263, &_2, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_2);
...
PHP_METHOD(Phalcon_Html_Tag, link) {
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "<a");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 263, &_0, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, select) {
	...
	if (zephir_is_true(&useEmpty)) {
		...
		ZEPHIR_CALL_FUNCTION(&outputEmpty, "sprintf", NULL, 170, &_10$$7, &emptyValue, &emptyText);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_METHOD(&_11, this_ptr, "renderattributes", NULL, 263, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	...
	if (Z_TYPE_P(data) == IS_OBJECT) {
		...
		ZEPHIR_CALL_METHOD(&_12$$10, this_ptr, "renderselectresultset", NULL, 271, data, &using, &value, &_14$$10);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_METHOD(&_15$$11, this_ptr, "renderselectarray", NULL, 272, data, &value, &_17$$11);
		zephir_check_call_status();
...
PHP_METHOD(Phalcon_Html_Tag, stylesheet) {
	...
	ZEPHIR_INIT_NVAR(&_2);
	ZVAL_STRING(&_2, "<link");
	ZEPHIR_CALL_METHOD(&_8, this_ptr, "renderattributes", NULL, 263, &_2, &parameters);
	zephir_check_call_status();
	ZVAL_BOOL(&_3, 1);
	ZEPHIR_CALL_METHOD(&_9, this_ptr, "renderclosetag", NULL, 269, &_3);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, textArea) {
	...
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 263, &_2, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_6, "htmlspecialchars", NULL, 210, &content);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderInput) {
	...
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "renderattributes", NULL, 263, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "renderclosetag", NULL, 269);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderInputChecked) {
	...
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "<input");
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "renderattributes", NULL, 263, &_1, &parameters);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_6, this_ptr, "renderclosetag", NULL, 269);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&output);
...
PHP_METHOD(Phalcon_Html_Tag, renderSelectArray) {
	...
	if (Z_TYPE_P(&options) == IS_ARRAY) {
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&options), _2, _3, _0)
		{
			...
			ZEPHIR_CALL_FUNCTION(&label, "htmlspecialchars", &_4, 210, &optionValue);
			zephir_check_call_status();
			if (Z_TYPE_P(&optionText) == IS_ARRAY) {
				ZEPHIR_INIT_NVAR(&_5$$4);
				ZEPHIR_GET_CONSTANT(&_5$$4, "PHP_EOL");
				ZEPHIR_CALL_METHOD(&_6$$4, this_ptr, "renderselectarray", &_7, 272, &optionText, value, &closeOption);
				zephir_check_call_status();
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&optionText) == IS_ARRAY) {
					...
					ZEPHIR_CALL_METHOD(&_17$$12, this_ptr, "renderselectarray", &_7, 272, &optionText, value, &closeOption);
					zephir_check_call_status();
